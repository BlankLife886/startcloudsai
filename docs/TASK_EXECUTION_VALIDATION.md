...
> 文档状态（2026-09-22）：历史验证报告（2026-09-09），2026-09-22 仅核对文档。44 项与相关回归的结果、迁移及日志均属于原测试时点；当前对话池默认 32、全局对话 128，并增加 Agent 独立闸门，开放图片直通也不属于旧执行池测试范围。 当前规则见 [SERVER_CURRENT_STATE.md](SERVER_CURRENT_STATE.md)。
