export default {
    ...
    settingsPanels: {
        common: { auto: "Auto", none: "None", minimal: "Minimal", low: "Low", medium: "Medium", high: "High", xhigh: "Extra high", max: "Max" },
        image: { title: "Image settings", quality: "Quality", size: "Size", sizeMode: "Size mode", ratioMode: "Ratio and resolution", exactMode: "Exact dimensions", exactWidth: "Width (px)", exactHeight: "Height (px)", exactStep: "{{step}} px increments", align16: "Align to multiples of 16", align16Short: "×16", align16Hint: "Round dimensions up to the next multiple of 16 after input", aspectRatio: "Aspect ratio", resolution: "Resolution", transparent: "Transparent background", transparentHint: "Generate an image without a background when supported by the model", count: "Image count", countShort: "Count", countUnit: "images", images: "{{count}} images" },
    ...
    canvas: {
        ...
        create: "New canvas",
        createDescription: "Start creating from a blank canvas",
        recent: "Recent projects",
        searchProjects: "Search canvases",
        clearSearch: "Clear search",
        noMatchingProjects: "No matching canvases",
        blank: "Blank canvas",
        ...
        toolbar: {
            ...
            themeMode: "Theme", light: "Light", dark: "Dark", gridStyle: "Grid style", dots: "Dots", lines: "Lines", blank: "Blank", imageInfo: "Image info", storyboard: "Batch config",
        },
        storyboard: {
            title: "Batch config", subtitle: "Enter prompts, split by text, or generate many images from one prompt", stepsLabel: "Batch workflow", stepUnderstand: "Understand", stepReview: "Review shots", stepGenerate: "Generate",
            scriptTitle: "Script", scriptPlaceholder: "Paste a script, sectioned text, or natural-language description…", useExample: "Example", needScript: "Add some text", autoDetected: "Will split into {{count}} shots",
            style: "Visual style", styleCinematic: "Cinematic", styleAnime: "Animated film", styleDocumentary: "Documentary", styleCommercial: "Brand commercial", sceneCount: "Shot count", ratio: "Frame", ratioAuto: "Auto", ratioLandscape: "Landscape", ratioPortrait: "Portrait", ratioSquare: "Square", consistency: "Cast continuity", consistencyHint: "Keep subjects, wardrobe, and color language consistent", aiRefine: "Polish copy", analyzing: "Polishing…", aiSource: "Polished", rulesSource: "Rule split", sourceLabel: "Text source", focusScene: "Focus on canvas",
            previewTitle: "Shots", sequenceOverview: "Timeline", filmstripHint: "Duration", totalDuration: "{{duration}} sec total", shots: "shots", shotTitle: "Title", shotSummary: "Summary", shotEditorTitle: "Edit shot {{index}}", shotEditHint: "Click the card to edit", addFirstShot: "Add shot 1", deleteShot: "Delete this shot", empty: "Shots appear after you enter a script", emptyHint: "Split rules set boundaries; AI only polishes copy", openWorkbench: "Open storyboard workbench", workbenchSubtitle: "Edit the script, review shots, and control generation in a dedicated workspace", workbenchSource: "Script and inputs", workbenchSourceHint: "This is the current storyboard script copy; input connections and shot selection stay managed on the canvas node.", workbenchShotDetail: "Shot {{index}} details", workbenchDetailHint: "Framing changes only when you explicitly choose it; otherwise it stays medium.", workbenchFooterSummary: "{{shots}} shots · {{selected}} selected inputs", exportPlan: "Export storyboard JSON", canvasGroupMeta: "{{count}} shots · placed on canvas",
            shotWide: "Wide", shotFull: "Full", shotMedium: "Medium", shotClose: "Close-up", shotDetail: "Detail", shotOver: "Over-the-shoulder", shotTypeLabel: "Shot {{index}} framing", statusQueued: "Queued", statusRunning: "Generating", statusSucceeded: "Complete", statusFailed: "Retry needed", statusCanceled: "Canceled", progress: "{{completed}} / {{total}} complete", partialFailure: "{{failed}} shots need a retry", costHint: "{{count}} independent storyboard images",
            generate: "Generate {{count}} shots", generating: "Generating…", cancel: "Cancel generation", retryScene: "Retry shot", retrying: "Retrying…", busy: "Another storyboard is generating. Wait for it to finish before retrying.", analysisFallback: "AI is unavailable; rules were used instead", generationFailed: "Storyboard generation failed", complete: "{{count}} storyboard images complete", partialCanceled: "{{canceled}} shots canceled", needsRegeneration: "{{count}} shot(s) changed; regenerate to update the image",
            configTitle: "Batch config", configSubtitle: "Split text into prompts or generate many images from one prompt", configAutoSubtitle: "Ingest text · split or reuse prompt · output images", configShots: "{{count}} images", configScript: "Prompt / text", configConnectedBadge: "Following connected text", configLocalOverrideBadge: "Local script override", configSyncConnected: "Sync connected text", configSyncConnectedTitle: "Connected text changed. Syncing will discard the local script override and follow the connection again.", inputManager: "Input manager", inputManagerSummary: "Selected {{selected}}/{{total}} · text {{text}} · images {{images}}", inputManagerEmpty: "No connected inputs", inputPrimary: "Primary script", inputMakePrimary: "Make primary", inputPrimaryShort: "Primary", inputPrimaryFor: "Make {{title}} the primary script", inputPrimaryRequired: "Choose one primary script", inputTooManyImages: "{{count}} reference images are selected, but this batch supports at most {{max}}. Deselect some before generating.", inputRoleLabel: "Reference role for {{title}}", inputScopeLabel: "Shot scope for {{title}}", inputScopeAll: "All shots", inputScopeSelected: "Selected shots", inputShotLabel: "Shot {{index}}", inputRoleScript: "Primary script", inputRoleContext: "Context text", inputRoleCharacter: "Character reference", inputRoleStyle: "Style reference", inputRoleScene: "Scene reference", inputRoleObject: "Object/product", inputRoleReference: "General reference", configScriptAria: "Prompt or text", configPlaceholder: "One prompt per line for different images…", configPromptAria: "Prompt", configPromptPlaceholder: "Enter one prompt to generate multiple independent images…", configRatio: "Aspect ratio", configShotCountAria: "Shot count", configVariantCount: "Image count", configVariantCountAria: "Image count", configConnectedInputs: "{{count}} text input(s) connected", configPasteOrConnect: "Paste text or connect a text node", configConsistencyOn: "Consistent cast", configConsistencyOff: "Independent shots", configCancelQueued: "Cancel queue", configStop: "Stop analysis", configStopFormat: "Stop formatting", configStopGenerate: "Stop generation", configGenerate: "Analyze and generate", configGenerateAuto: "Generate {{count}} images", configRegenerate: "Generate {{count}} again", configCanceled: "Batch generation canceled", configCompleteSummary: "{{title}} · {{count}} images", configAutoDetect: "Detect count from text structure", configAutoDetectShort: "Auto-detect", batchModeSplit: "Split by text", batchModeVariants: "One prompt, many variants", batchModeRefs: "One prompt, many images", batchModeSplitHint: "Split by line / paragraph into separate prompts", batchModeVariantsHint: "Generate multiple independent images from one prompt by count", batchModeRefsHint: "Apply one prompt to each input image; designate extra reference images", promptListOpen: "Manage prompts", promptListOpenTitle: "Edit every prompt as a list", promptListOpenTitleVariants: "Edit the shared multi-image prompt", promptListOpenTitleRefs: "Edit the prompt for multi-image generation", promptListTitle: "Prompt list", promptListTitleVariants: "Edit prompt", promptListHint: "Numbered rows you can edit one by one", promptListHintVariants: "Edit the shared prompt used for every image", promptListTitleRefs: "Edit prompt", promptListHintRefs: "The same prompt is applied to each input image", configRefsHint: "One image per input", refsRequired: "Connect at least one input image first", configInputImages: "Input images", configReferenceImages: "References", configMarkAsInput: "Use as input", configMarkAsReference: "Use as reference", configReferenceRole: "Reference role", inputRoleInput: "Input image", promptListSerializeHint: "Saving writes text back using the current split rule", promptListRowPlaceholder: "Prompt {{index}}", promptListRowAria: "Prompt {{index}}", promptListAdd: "Add prompt", promptListDelete: "Delete prompt", promptListMoveUp: "Move up", promptListMoveDown: "Move down", alreadyRunning: "A batch job is already generating", scriptRequired: "Add a prompt or connect a text node first", analysisFailed: "Batch analysis failed", analysisNotReady: "Configure a text model before analyzing",
            textModel: "Text recognition model", imageModel: "Image model", modelChange: "Change", modelCollapse: "Hide", parseMode: "Split rule", scriptTooLong: "This script exceeds {{max}} characters. Split it into multiple storyboard batches before generating.", parseModeLines: "By line", parseModeParagraphs: "By paragraph", parseModeMarkers: "By marker", parseModeProse: "By sentence", aiPolish: "AI polish", aiPolishOn: "AI polish on", aiPolishOff: "Rules only", shotMetaLocation: "Location", shotMetaTime: "Time", stageFormatting: "Splitting shots by rule…", stageAnalyzing: "AI polishing shots…", stageGenerating: "Generating storyboard images…", stageGeneratingProgress: "Generating storyboard images {{done}}/{{total}}",
            sectionInput: "Input", sectionModels: "Models", sectionOptions: "Options", inputChipText: "Text ×{{count}}", inputChipPaste: "Paste or connect text",
            pipelineInputTitle: "Script input", pipelineDetectTitle: "Detect shots", pipelineDetectSubtitle: "Split the script into shots", pipelineDetectAction: "Detect shots", pipelineDetectStop: "Stop detection", pipelineDetectHint: "Connect text, then detect to build a shot list", pipelineAnalyzeTitle: "Analyze", pipelineAnalyzeSubtitle: "AI storyboard plan", pipelineAnalyzeAction: "Start analysis", pipelineAnalyzeHint: "Finish detection first, then analyze into a generation plan", pipelineGenerateTitle: "Generate images", pipelineGenerateSubtitle: "Batch-generate shot images", pipelineGenerateAction: "Generate images", pipelineGenerateHint: "Finish analysis first, then generate the shot images", pipelineScriptReady: "Script connected · {{count}} chars", pipelineScriptMissing: "Connect or paste a script first", detectComplete: "Detected {{count}} shots", detectFailed: "Shot detection failed", detectRequired: "Run Detect shots first", analyzeComplete: "Analyzed {{count}} shots", analyzeRequired: "Run Analyze first",
        },
        workflow: {
            run: "Run workflow",
            rerun: "Run workflow again",
            stop: "Stop workflow",
            cancelQueuedCount: "Cancel {{count}} queued tasks",
            parallelRunning: "{{count}} nodes generating in parallel",
            finishingSubmitted: "Started tasks will keep running",
            queuedNodesCanceled: "Canceled {{count}} queued nodes",
            progress: "Running {{completed}}/{{total}}",
            costLabel: "Full workflow",
            empty: "This canvas has no executable generation config nodes",
            cycle: "The workflow contains a cycle. Fix the connections before running it.",
            invalidConnection: "The workflow directly connects config nodes. Add a text, image, or other output node between each pair of config nodes.",
            graphChanged: "The workflow graph changed, so execution was paused. Review it and run again.",
            nodeMissing: "A workflow node no longer exists, so the run was stopped",
            unsupportedMedia: "Node “{{name}}” uses video or audio generation, which is not available for workflows",
            notReady: "Node “{{name}}” has no composed prompt or usable input. Finish configuring it first.",
            dependencyIncomplete: "Node “{{name}}” is waiting for prerequisite “{{dependency}}”; no generation was submitted.",
            referenceMissing: "Node “{{name}}” references missing resource “{{reference}}”; no generation was submitted.",
            referenceEmpty: "Node “{{name}}” references empty resource “{{reference}}”; no generation was submitted.",
            localImageInputMissing: "The image operation node has no usable input image.",
            localOutputCountMismatch: "The image operation returned a different number of outputs than configured.",
            outputMissing: "Node “{{name}}” did not create its expected output node, so the workflow was paused.",
            outputIncomplete: "Node “{{name}}” expected {{expected}} valid outputs but received {{actual}}, so the workflow was paused.",
            modelUnavailable: "Node “{{name}}” has no available model. Configure a model first.",
            pricingUnavailable: "Pricing for node “{{name}}” is unavailable. The workflow was not started to avoid unknown charges.",
            failed: "Node “{{name}}” failed. The workflow was stopped.",
            failedShort: "Workflow failed",
            failedLabel: "Failed",
            retry: "Retry from failure",
            retryShort: "Retry",
            running: "Generating",
            stopping: "Stopping",
            resumed: "Workflow restored and continuing from the interruption point.",
            preparing: "Preparing",
            backgroundRunning: "Workflow is running elsewhere",
            lockedShort: "Elsewhere",
            runningElsewhere: "This canvas already has an active workflow. You can monitor or stop it.",
            completedElsewhere: "The workflow finished elsewhere. Refresh to load the latest results.",
            refreshResults: "Refresh results",
            syncFailed: "Workflow state could not be synchronized. Execution was paused; retry to continue.",
            terminalPersistenceFailed: "The workflow ended, but its local state could not be saved. You can run it again while saving retries in the background.",
            completed: "Workflow completed with {{count}} nodes",
            canceled: "Workflow stopped. You can run it again.",
        },
        project: {
        ...
        sync: {
            ...
            loadFailed: "Failed to load the canvas document from the cloud. Please try again later.",
        },
        createMenu: {
            ...
            basic: "Basics", extensions: "Extensions", search: "Search nodes", empty: "No matching nodes",
        ...
        sidePanel: {
            canvas: "Canvas", assets: "Assets", prompts: "Prompts", recent: "Recent", recentProjects: "Recently edited", recentMeta: "{{count}} nodes · {{date}}", noRecent: "No other projects", noRecentHint: "New and recently opened canvases appear here", resize: "Resize left panel", elements: "Canvas elements", select: "Select", searchNodes: "Search nodes", focusNode: "Focus node", preview: "Large preview", workflow: "Workflow", standaloneNodes: "Standalone nodes", noNodes: "No nodes on this canvas", noNodesHint: "Right-click the canvas or add a node from the toolbar", clearAll: "Clear all", selected: "{{count}} selected", exporting: "Exporting selected elements…", exportName: "canvas-elements-{{count}}", exported: "Exported {{count}} elements", exportFailed: "Export failed. Try again.",
            addingAssets: "Adding assets…", addedAssets: "Added {{count}} assets", mediaOnly: "Only image and video files are supported", addFailed: "Failed to add assets. Try again.", searchAssets: "Search assets", add: "Add", noAssets: "No assets", noAssetsHint: "Images are shared with My Assets. Upload files here to insert them anytime.", inserted: "Insert into canvas", removeAssetTitle: "Remove this asset?", remove: "Remove", removeAsset: "Remove asset", assetRemoved: "Asset removed",
            searchPrompts: "Search prompts", noPrompts: "No prompts", noPromptsHint: "Prompts will appear here. Click one to insert it onto the canvas", promptCopied: "Prompt copied", copyFailed: "Copy failed", loadFailedRetry: "Load failed. Click to retry.", noMatchingPrompts: "No matching prompts", sourceEmpty: "No prompts from this source", viewDetails: "View details",
        ...
        imageTools: { copyPrompt: "Copy prompt", copyPromptTitle: "Copy the prompt used to generate this image", reversePrompt: "Reverse prompt", reversePromptTitle: "Create text and configuration nodes to infer the prompt", replace: "Replace image", locked: "Lock ratio", free: "Free ratio", lockTitle: "Switch to proportional scaling", freeTitle: "Switch to free resizing", mask: "Local edit", maskTitle: "Paint a mask and edit the selected area", crop: "Crop", cropTitle: "Crop into a new node", split: "Split", splitTitle: "Split the image by rows and columns", upscale: "Upscale", upscaleTitle: "Increase image resolution", removeBackground: "Remove background", removeBackgroundTitle: "Remove the background with the current image model and create a new node", removeBackgroundPrompt: "Remove the background, keep the original subject, and output a transparent background.", removeBackgroundUnavailable: "The current image model does not support background removal", angle: "Multi-angle", angleTitle: "Generate another angle", view: "View image", viewTitle: "View image details", more: "More", configure: "Configure quick tools", customize: "Customize toolbar", reorder: "Drag tools in the preview to reorder", moveLeft: "Move left", moveRight: "Move right", emptyVisible: "No tools are visible yet", showLabels: "Show button labels", description: "Choose the quick tools shown in the image-node toolbar.", preview: "Node preview", imageNode: "Image node", quickTools: "Quick tools" },
        nodeToolbar: { noPrompt: "No prompt to copy", renameTitle: "Rename node", rename: "Rename", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", delete: "Delete", retryTitle: "Generate again", saveAsset: "Save asset", downloadAudio: "Download audio", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", storyboardTitle: "Generate storyboard from text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Node size", originalSize: "Original size", mimeType: "File type", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "File size" },
        operationNodes: { crop: "Crop node", cropDescription: "Output an image using a saved crop region", split: "Split node", splitDescription: "Output image slices using saved rows and columns", upscale: "Upscale node", upscaleDescription: "Upscale the input image to a target long edge", angle: "Multi-angle node", angleDescription: "Generate a new view from the input image", anglePrompt: "Regenerate the same subject from a new view based on the reference image. Preserve the subject, colors, materials, and visual style; do not merely distort perspective. Rotate 45 degrees right at eye level with a medium camera distance and standard lens.", reversePrompt: "Reverse prompt node", reversePromptDescription: "Infer a reusable image-generation prompt from the input image" },
        configNode: { title: "Generation config", image: "Image", text: "Text", video: "Video", audio: "Audio", prompt: "Prompt", references: "Refs", videoReferences: "Videos", audioReferences: "Audio", items: "{{count}} items", images: "{{count}} images", model: "Select model", params: "Parameters", emptyInputs: "No inputs connected", compose: "Compose", composed: "Composed", stop: "Stop", generate: "Generate", regenerate: "Regenerate", generateWithCost: "Generate · {{count}} credits", cancelQueued: "Cancel queued", generating: "Generating · {{duration}}", generatedAt: "Generated at {{time}}", failedAt: "Failed at {{time}}", canceledAt: "Stopped at {{time}}", queued: "Queued", duration: "Took {{duration}}", stopWithDuration: "Stop · {{duration}}", operationInput: "Input image", operationParams: "Operation settings", angleParams: "View settings", configureOperation: "Configure operation", editInstruction: "Edit analysis instruction", analysisInstruction: "Analysis instruction", analysisInstructionPlaceholder: "Describe the prompt details to extract from the image", runOperation: "Run {{operation}}", rerunOperation: "Run {{operation}} again", queuedOperation: "{{operation}} queued", processingOperation: "Running {{operation}} · {{duration}}", processingOperationProgress: "Running {{operation}} · {{completed}}/{{count}} · {{duration}}", operationCompleted: "{{operation}} completed · {{duration}}", operationFailed: "{{operation}} failed · {{duration}}", operationReady: "{{operation}} node ready", operationReadyLocal: "Local processing · no credits used", singleImageOnly: "This node accepts exactly one input image", cropSummary: "Keep {{width}}% × {{height}}%", splitSummary: "{{rows}} rows × {{columns}} columns", upscaleSummary: "Long edge {{size}}px · {{algorithm}}" },
        costConfirm: { eyebrow: "Credits", title: "Confirm generation cost", description: "Estimated cost is reserved first, then settled after the task finishes.", caption: "Estimated · reserved now, settled after the task", cancel: "Cancel", confirm: "Confirm", recharge: "Add credits", skip: "Don't ask every time", estimate: "Estimated total", sum: "Total", credits: "credits", generation: "Image", textItem: "Text", transparentItem: "Transparent background", total: "{{count}} credits", actual: "Billed by actual usage", perImage: "{{unit}} credits / image", perText: "{{unit}} credits / reply", perRun: "{{unit}} credits / run", perImageShort: "{{unit}}/image", perTextShort: "{{unit}}/reply", perRunShort: "{{unit}}/run", qty: "{{unit}} × {{count}}", available: "{{count}} credits available", remaining: "{{count}} credits after payment", availableLabel: "Available", remainingLabel: "After payment", reading: "Reading", pending: "Pending", insufficient: "Not enough", insufficientHint: "Your wallet balance is too low. Add credits before submitting.", pricingUnavailable: "The unit price is unavailable, so the server will settle the final cost.", backgroundRemove: "Background removal", transparent: "Transparent background · {{unit}} credits / image" },
        projectPage: {
            leaveEyebrow: "Work in progress", leaveTitle: "This canvas still has running tasks", leaveDescription: "Stay until they finish, or stop this canvas's Agent, workflow, generation, and storyboard tasks before leaving.", leaveStay: "Stay on canvas", leaveStopAndLeave: "Stop all and leave", leaveStopping: "Stopping…", leaveStopFailed: "Could not stop every canvas task. Please try again.",
            stopEyebrow: "Stop task", stopTitle: "Stop the current task?", stopDescription: "Generation will stop. Credits reserved for unsubmitted tasks are returned; submitted tasks are settled against the reserved credits.", stopWorkflowDescription: "Stop remaining nodes and the currently submitted task. Credits reserved for unsubmitted tasks are returned; submitted tasks are settled against the reserved credits.", stop: "Stop task", stopFailed: "Could not stop the task. Please try again.", stopQueued: "Stop remaining", continue: "Keep waiting", mediaUnavailable: "Video and audio are not available yet", configConnection: "Configuration nodes cannot be connected to each other", notFound: "Current canvas not found", exporting: "Exporting current canvas…", exported: "Current canvas exported", clipboardText: "Clipboard text", clipboardImageAdded: "Added image from clipboard", clipboardTextAdded: "Added text from clipboard", clipboardUnavailable: "Clipboard access was denied", noTextToSave: "No text to save", canvasText: "Canvas text", noVideoToSave: "No video to save", canvasVideo: "Canvas video", noImageToSave: "No image to save", canvasImage: "Canvas image", emptyReverse: "The image node is empty, so its prompt cannot be inferred", reverseTitle: "Reverse prompt", reverseConfigTitle: "Reverse prompt configuration", splitTitle: "{{name}} {{row}}-{{column}}", splitSuccess: "Split into {{count}} child nodes", localOperationResult: "{{operation}} result", localOperationCompleted: "{{operation}} completed with {{count}} results", localOperationFailed: "{{operation}} failed", maskResult: "Local edit result", maskFailed: "Local edit failed", backgroundRemoved: "Background removed. The original node is unchanged.", backgroundRemoveFailed: "Failed to remove the background", generationFailed: "Generation failed", partialFailed: "Some images failed to generate", allFailed: "All images failed to generate", retryPromptMissing: "No prompt found for retry", referenceMissing: "The reference image is missing, so retry cannot continue", emptyTextImage: "The text node is empty, so an image cannot be generated", untitledCanvas: "Untitled canvas", notImplemented: "Not implemented yet", imageDetails: "Image details", clearEyebrow: "Clear confirmation", clearTitle: "Clear this canvas?", clear: "Clear", clearDescription: "Every node and connection on this canvas will be removed. This cannot be undone.", reversePreset: "Infer a prompt suitable for AI image generation from the reference image.\n\nRequirements:\n1. Output only the prompt, with no explanation.\n2. Cover the subject, composition, style, lighting, color, materials, lens, and atmosphere.\n3. Write a complete prompt that can be used directly with an image model.", maskPrompt: "Only modify the transparent masked area and keep everything else unchanged. {{prompt}}", editTextPrompt: "Revise the text according to the instructions.\n\nOriginal:\n{{source}}\n\nInstructions:\n{{prompt}}"
        },
        ...
        editors: {
            ...
            angleTitle: "AI Multi-angle", angleDescription: "The left side previews direction only; the result is regenerated from the original image", angleDrag: "Drag to change angle · scroll to change distance", angleNear: "Near", angleMid: "Mid", angleFar: "Far", horizontal: "Horizontal angle", pitch: "Pitch angle", distance: "Camera distance", lens: "Wide-angle lens", standard: "Standard", wide: "Wide", aiGenerate: "Generate with AI",
            upscaleTitle: "Upscale image", scale: "{{value}}×", source: "Source", targetPixels: "Target pixels", maxReached: "The image is already 4K and does not need upscaling", targetReached: "The image already meets the target pixel count", algorithm: "Upscaling algorithm", outputSize: "Output size", upscale: "Generate upscaled image", high: "High-quality interpolation", highDescription: "Best for photos and detailed images", bilinear: "Bilinear", bilinearDescription: "Smooth and fast", nearest: "Nearest neighbor", nearestDescription: "Best for pixel art",
            cropTitle: "Crop image", adjustCrop: "Adjust crop box", cropHint: "Scroll to pan · Ctrl+scroll to zoom · Space+drag to move", cropSize: "Crop size {{size}}", ratio: "Ratio {{ratio}}", original: "Original {{width}} x {{height}}", confirmCrop: "Crop", free: "Free", fixed: "Fixed", originalMode: "Original",
            maskTitle: "Local mask edit", maskHint: "Mouse wheel to zoom · middle button or Space + left drag to pan · Alt + left/right drag to resize brush · Ctrl/Cmd+Z to undo · Ctrl/Cmd+Shift+Z to redo", panKey: "Space", panHint: "drag to pan", brush: "Brush", erase: "Erase", brushTitle: "Brush (B)", eraseTitle: "Eraser (E). Right-click also erases", resetMaskTitle: "Clear mask", undoMaskTitle: "Undo mask stroke (Ctrl/Cmd+Z)", undoMask: "Undo mask stroke", redoMaskTitle: "Redo mask stroke (Ctrl/Cmd+Shift+Z)", redoMask: "Redo mask stroke", brushSize: "Brush size", editInstructions: "Edit instructions", maskPlaceholder: "For example: change the selected area to metal while preserving the original lighting", maskPromptRequired: "Enter edit instructions", maskRequired: "Paint the area to edit first", aiEdit: "Edit with AI", submitShortcut: "⌘↵",
        ...
        promptPanel: { video: "Describe the video you want to generate", audio: "Describe the audio you want to generate", image: "Describe the image you want to generate", text: "Describe the text you want to generate", editImage: "Describe how you want to change this image", editText: "Describe how you want to revise this text", expandEditor: "Expand editor", collapseEditor: "Collapse editor", editorTitle: "Edit prompt", charCount: "{{count}} characters", stopGeneration: "Stop generation", generate: "Generate", stop: "Stop" },
        promptLibrary: { title: "Prompt library", search: "Search prompts", category: "Category", tag: "Tags", use: "Use", empty: "No matching prompts", emptyHint: "Try a different keyword or filter", loadFailed: "Failed to load prompts", total: "{{count}} prompts" },
        ...
        controls: { ratio: "Ratio", duplicate: "Duplicate", delete: "Delete", deleteConnections: "Delete {{count}} connections", images: "{{count}} images", reasoning: "Reasoning" },
        generation: { interrupted: "Generation was interrupted by a page refresh. Generate again.", canceled: "Generation was canceled. Generate again.", front: "front view", rotateRight: "rotated {{angle}} degrees right", rotateLeft: "rotated {{angle}} degrees left", level: "eye-level view", topDown: "{{angle}}-degree top-down view", lowAngle: "{{angle}}-degree low-angle view", angleLabel: "AI multi-angle: {{horizontal}}, {{pitch}}, camera distance {{distance}}, {{lens}} lens", anglePrompt: "Regenerate a new view of the same subject from the reference image. Preserve the subject, colors, materials, and visual style; do not merely apply perspective distortion. {{angle}}." },
        agentOps: { add_node: "Add node", update_node: "Update node", delete_node: "Delete node", delete_connections: "Delete connections", connect_nodes: "Connect", create_generation_flow: "Create image flow", create_graph: "Build workflow", arrange_nodes: "Arrange layout", move_nodes: "Move nodes", resize_node: "Resize node", set_viewport: "Adjust view", select_nodes: "Select nodes", run_generation: "Run generation" },
    ...
    config: {
        ...
        localStorage: {
            ...
            stores: { appState: "App state", images: "Image files", media: "Audio and video files", agentMessages: "Agent messages", promptCache: "Prompt cache" },
        },
        promptSources: {
            add: "Add source",
    ...
    agent: {
        canvasHistoryTool: { undoTitle: "Undo Agent action", redoTitle: "Redo Agent action", undone: "Undid the last Agent canvas action", redone: "Redid the last Agent canvas action" },
        generationSettingsTool: { title: "Update generation settings", updated: "Updated {{count}} generation nodes", unchanged: "{{count}} generation nodes already use these settings" },
        ...
        siteTools: { webSearch: "Web search", canvasList: "Canvas list", workflowTemplateList: "Workflow templates", workflowTemplateInspect: "Inspect workflow template", workflowTemplateCreate: "Create canvas from template", workflowPreflight: "Workflow run preflight", generationStatus: "Generation task status", promptSearch: "Search prompts", assetList: "Asset list", assetAdd: "Add asset", unknownTool: "Unknown tool: {{name}}", canvasLoading: "The canvas is still loading. Try again shortly.", canvasHint: "Use site_navigate to open /canvas/{id}", workflowTemplateIdRequired: "Use the exact templateId returned by the template list", workflowTemplateAuthRequired: "Sign in before creating a canvas from a template", assetsLoading: "Assets are still loading. Try again shortly.", assetTitleRequired: "Provide the asset title", textContentRequired: "content is required when kind=text", imageUrlRequired: "imageUrl is required when kind=image", imageReadFailed: "Could not read the image. Use a data URL or a cross-origin accessible image URL.", assetKindUnsupported: "assets_add supports only kind=text or kind=image" },
        ...
        selection: { selectedNodes: "{{count}} nodes selected", selectedNodesTitle: "Selected canvas nodes", viewSelectedNodes: "View all selected nodes" },
        composer: { removeImage: "Remove image", removeSkill: "Remove Skill", uploadImage: "Upload image", stop: "Stop", send: "Send", credits: "credits", settings: "Model and options", settingsOpen: "Open model and options", modelSection: "Model", reasoningSection: "Reasoning", permissionSection: "Permissions", toolsSection: "Write permissions", model: "Model: {{model}}", selectModel: "Select a Codex model. Current: {{model}}", selectChatModel: "Select a model. Current: {{model}}", searchModel: "Search models", noMatchingModel: "No matching models", reasoning: "Reasoning effort: {{effort}}", selectReasoning: "Select reasoning effort. Current: {{effort}}", effortCount: "{{count}} levels", permissionLabel: "Permissions: {{mode}}", selectPermission: "Select Codex permission mode. Current: {{mode}}", effort: { none: "None", minimal: "Minimal", low: "Low", medium: "Medium", high: "High", xhigh: "Extra high", max: "Maximum", ultra: "Ultra" }, permission: { request: "Ask for approval", requestDescription: "Always ask before editing outside the workspace or accessing the network", automatic: "Automatic review", automaticDescription: "Codex reviews risky actions and asks only when needed", full: "Full access", fullShort: "Full access", fullDescription: "Unrestricted access to the network and local files" }, tools: { label: "Tool confirmation: {{mode}}", manual: "Manual", manualHint: "Ask first", manualDescription: "Ask before the Agent writes to the canvas", automatic: "Automatic", automaticHint: "Write immediately", automaticDescription: "Let the Agent perform canvas writes automatically", select: "Select tool confirmation mode. Current: {{mode}}" }, mentions: { selectSkill: "Select a Skill", selectResource: "Reference canvas assets", loadingSkills: "Loading Skills…", noSkills: "No enabled Skills match", noResources: "No matching canvas assets", previewUnavailable: "This asset cannot be previewed", referenceLabel: "Referenced {{kind}}: {{title}}", resourceMissing: "Canvas asset “{{title}}” no longer exists", imageReadFailed: "Could not read canvas image “{{title}}”", kind: { image: "Image", video: "Video", audio: "Audio", text: "Text" } } },
        ...
        hosted: { reviewOutputs: "Review outputs", reviewing: "Waiting for tasks and reviewing outputs…", heading: "AGENT", subtitle: "Built-in model", placeholder: "Describe a canvas change, for example: add a prompt node next to the selection", composerHint: "Enter to send · Shift+Enter for a new line · @ to mention nodes", applying: "Applying to canvas…", webSearching: "Searching the web…", webSearchCompleted: "Web search complete with {{count}} sources", webSearchFailed: "Web search failed", toolReading: "Reading the canvas…", toolModifying: "Modifying the canvas…", toolGenerating: "Processing generation tasks…", toolWorking: "Running {{tool}}…", applied: "Applied to canvas", failed: "Canvas agent failed", authFailed: "The chat model credential is invalid. Check the chat provider API key in admin settings.", interrupted: "The connection was interrupted. Started generation tasks remain on the canvas; check their node status before retrying.", emptyTitle: "Change the canvas in one sentence", empty: "Describe what you want to create or change on the canvas.", suggestions: { layout: "Tidy up the current canvas layout", flow: "Create an image flow from the selection", prompt: "Add a prompt node next to the selection", status: "Check current generation status" }, newChat: "New chat", linked: "Linked {{count}} connections", appliedCount: "Applied {{count}} operations", ignoredOps: "Ignored {{count}} invalid operations", noValidOps: "No operations applied; refreshed canvas state returned", addedNodes: "Added {{count}} nodes", readCanvas: "Read the canvas", generationStatus: "Generation status", generationTriggered: "Triggered {{count}} nodes", generationSelectionSkipped: "Skipped {{count}} nodes without a valid image", generationSucceeded: "{{count}} succeeded", generationRunning: "{{count}} running", generationFailed: "{{count}} failed", generationUnknown: "Status unconfirmed for {{count}} tasks; no automatic rerun", generationIdle: "No generation tasks", openedPage: "Opened {{path}}", attachmentNodes: "Placed {{count}} images on the canvas", listedItems: "{{count}} items", workflowTemplateInspected: "Read {{title}}: {{nodes}} nodes, {{workflows}} workflows", workflowTemplateCreated: "Created {{title}} from a template", workflowPreflight: "Preflighted {{nodes}} nodes: {{price}} credits ({{paid}} paid, {{free}} free)", assetAdded: "Added to assets", reasoningStandard: "Standard", reasoningExtended: "Deep", reasoningStandardWithPrice: "Standard · {{price}} credits", reasoningExtendedWithPrice: "Deep · {{price}} credits", turnPrice: "{{price}} credits/turn", turnPriceSale: "{{price}} credits/turn", generationChargedSeparately: "The Agent is billed per turn; model generation is billed separately", reasoningNotReturned: "The upstream model used reasoning tokens, but the provider did not return a reasoning summary that can be displayed.", noHistory: "This canvas has no conversation history yet", deleteChat: "Delete chat", justNow: "Just now", minutesAgo: "{{count}} min ago", yesterday: "Yesterday" },
        visual: { inspection: "Inspected {{count}} real images and found {{duplicates}} duplicate or highly similar relationships", inspectTool: "Inspect real images" },
        ...
        eventExtra: { toolNamed: "Call tool: {{name}}", toolOperation: "Tool operation", targetPage: "Target page", searchContent: "Search query", textContent: "Text content", operationContent: "Operations", imageCount: "Image count", tools: { generateImage: "Generate image", viewImage: "View image", executeCommand: "Run command", editFiles: "Edit files", searchWeb: "Search the web", canvasOps: "Canvas operations", readCanvas: "Read canvas", readSelection: "Read selection", findNodes: "Find nodes", inspectNodes: "Inspect nodes", focusNodes: "Focus nodes", duplicateSelection: "Duplicate selection", imageOperation: "Create image operation", replaceWorkflowInput: "Replace workflow input", runDownstream: "Run affected downstream", listAgentHistory: "View Agent history", createCheckpoint: "Create checkpoint", restoreCheckpoint: "Restore checkpoint", restoreTransaction: "Restore history transaction", validateWorkflow: "Validate workflow", stopWorkflow: "Stop workflow", resumeWorkflow: "Resume workflow", retryFailedNodes: "Retry failed nodes", exportSnapshot: "Export snapshot", createNode: "Create node", addAttachments: "Add attachment images", createText: "Create text", createTexts: "Create text nodes", createConfig: "Create generation config", createImageFlow: "Create image flow", createGenerationFlow: "Create generation flow", generateText: "Generate text", generateVideo: "Generate video", generateAudio: "Generate audio", updateNode: "Update node", updateText: "Update text", moveNodes: "Move nodes", resizeNode: "Resize node", deleteNodes: "Delete nodes", connectNodes: "Connect nodes", selectNodes: "Select nodes", setViewport: "Adjust viewport", runGeneration: "Run generation", openPage: "Open page" } },
        eventMore: { toolRunning: "{{action}}…", openedRoute: "Opened {{route}}", canvasCount: "{{count}} canvases", workflowTemplateCount: "Found {{count}} workflow templates", workflowTemplateInspected: "Workflow template structure loaded", workflowTemplateCreated: "Created a canvas from the template", workflowPreflight: "Preflighted {{count}} nodes: {{price}} credits", promptCount: "Found {{count}} prompts", assetCount: "{{count}} assets", assetAdded: "Added to My Assets", generationStatus: "{{total}} tasks: {{queued}} queued, {{running}} running, {{succeeded}} succeeded, {{failed}} failed", canvasRead: "Current canvas read", selectionRead: "Current selection read", textNodes: "{{count}} text nodes", imageNodes: "{{count}} images", configNodes: "{{count}} config nodes", videoNodes: "{{count}} videos", audioNodes: "{{count}} audio nodes", groupNodes: "{{count}} groups", otherNodes: "{{count}} other nodes", connections: "{{count}} connections", emptyCanvas: "The canvas is empty", executeTool: "Run {{tool}}", thinking: "Thinking...", operationRunning: "{{operation}} is running...", organizingCanvas: "Canvas read; Codex is organizing the result...", operationCompleted: "{{operation}} completed; Codex is continuing...", attachmentPrompt: "Please process the uploaded image attachments.", routes: { home: "Home", canvas: "Canvas", canvasProject: "Selected canvas", assets: "My Assets", config: "Settings" } },
        runtime: {
