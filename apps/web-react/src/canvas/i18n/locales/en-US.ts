export default {
    ...
    canvas: {
        ...
        toolbar: {
            ...
            themeMode: "Theme", light: "Light", dark: "Dark", gridStyle: "Grid style", dots: "Dots", lines: "Lines", blank: "Blank", imageInfo: "Image info", storyboard: "Storyboard",
        },
        storyboard: {
            title: "Storyboard studio", subtitle: "Turn a script into an editable, generation-ready shot list", stepsLabel: "Storyboard workflow", stepUnderstand: "Understand", stepReview: "Review shots", stepGenerate: "Generate",
            scriptTitle: "Story text", scriptPlaceholder: "Paste a story, script, or product brief. AI will identify scenes, actions, and camera language…", useExample: "Use example", needScript: "Add some text", autoDetected: "{{count}} shots detected",
            style: "Visual style", styleCinematic: "Cinematic", styleAnime: "Animated film", styleDocumentary: "Documentary", styleCommercial: "Brand commercial", sceneCount: "Shot count", ratio: "Frame ratio", ratioLandscape: "Landscape", ratioPortrait: "Portrait", ratioSquare: "Square", consistency: "Character and style continuity", consistencyHint: "Keep subjects, wardrobe, props, and color language consistent", aiRefine: "Refine with AI", analyzing: "Understanding…", aiSource: "AI structured", rulesSource: "Rule parsed", sourceLabel: "Text source", focusScene: "Focus on canvas",
            previewTitle: "Shot sequence", sequenceOverview: "Timeline", filmstripHint: "Duration", totalDuration: "{{duration}} sec total", shots: "shots", shotTitle: "Shot title", shotSummary: "Shot description", empty: "Add text to start planning", emptyHint: "Scenes, action, and camera language will be identified", exportPlan: "Export storyboard JSON", canvasGroupMeta: "{{count}} shots · placed on canvas",
            shotWide: "Wide", shotFull: "Full", shotMedium: "Medium", shotClose: "Close-up", shotDetail: "Detail", shotOver: "Over-the-shoulder", statusQueued: "Queued", statusRunning: "Generating", statusSucceeded: "Complete", statusFailed: "Retry needed", statusCanceled: "Canceled", progress: "{{completed}} / {{total}} complete", partialFailure: "{{failed}} shots need a retry", costHint: "{{count}} independent storyboard images",
        ...
        projectPage: {
            leaveEyebrow: "Agent running", leaveTitle: "The Agent is operating this canvas", leaveDescription: "Stay until the Agent finishes, or stop this canvas's Agent, workflow, and generation tasks before leaving.", leaveStay: "Stay on canvas", leaveStopAndLeave: "Stop all and leave", leaveStopping: "Stopping…", leaveStopFailed: "Could not stop every canvas task. Please try again.",
