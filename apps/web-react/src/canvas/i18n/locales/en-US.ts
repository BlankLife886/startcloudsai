export default {
    ...
    canvas: {
        ...
        nodeToolbar: { noPrompt: "No prompt to copy", renameTitle: "Rename node", rename: "Rename", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", delete: "Delete", retryTitle: "Generate again", saveAsset: "Save asset", downloadAudio: "Download audio", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Node size", originalSize: "Original size", mimeType: "File type", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "File size" },
