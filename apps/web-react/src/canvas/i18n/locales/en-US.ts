export default {
    ...
    canvas: {
        ...
        agentOps: { add_node: "Add node", update_node: "Update node", delete_node: "Delete node", delete_connections: "Delete connections", connect_nodes: "Connect", create_generation_flow: "Create image flow", create_graph: "Build workflow", move_nodes: "Move nodes", resize_node: "Resize node", set_viewport: "Adjust view", select_nodes: "Select nodes", run_generation: "Run generation" },
    ...
    agent: {
        ...
        hosted: { subtitle: "Built-in model", placeholder: "Describe a canvas change, for example: add a prompt node next to the selection", applying: "Applying to canvas…", applied: "Applied to canvas", failed: "Canvas agent failed", authFailed: "The chat model credential is invalid. Check the chat provider API key in admin settings.", empty: "Operate the canvas with the built-in model. Codex is not required.", newChat: "New chat", linked: "Linked {{count}} connections", appliedCount: "Applied {{count}} operations", addedNodes: "Added {{count}} nodes", readCanvas: "Read the canvas", generationStatus: "Generation status", generationTriggered: "Triggered {{count}} nodes", generationSucceeded: "{{count}} succeeded", generationRunning: "{{count}} running", generationFailed: "{{count}} failed", generationIdle: "No generation tasks", openedPage: "Opened {{path}}", attachmentNodes: "Placed {{count}} images on the canvas", listedItems: "{{count}} items", assetAdded: "Added to assets", reasoningStandard: "Standard", reasoningExtended: "Deep", reasoningStandardWithPrice: "Standard · {{price}} credits", reasoningExtendedWithPrice: "Deep · {{price}} credits", turnPrice: "{{price}} credits/turn", generationChargedSeparately: "The Agent is billed per turn; model generation is billed separately", reasoningNotReturned: "The upstream model used reasoning tokens, but the provider did not return a reasoning summary that can be displayed." },
