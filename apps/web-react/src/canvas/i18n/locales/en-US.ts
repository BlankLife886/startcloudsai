export default {
    ...
    canvas: {
        homePage: {
            rail: {
                nav: "Infinite canvas navigation",
                launchpad: "Launchpad",
                library: "Library",
                templates: "Templates",
                search: "Search",
                quotaTitle: "Canvases",
                quota: "Canvases {{used}} / {{limit}}",
                quotaBonus: "Base {{base}} + plan {{bonus}}",
                quotaLoading: "Loading quota…",
                quotaFull: "Full — delete one to create more",
                quotaLeft: "{{count}} more available",
                login: "Sign in to save canvases",
                loginHint: "Cloud save · Sync across devices",
            },
            hero: {
                ...
                previous: "Previous",
                next: "Next",
                switchFeatured: "Switch featured template",
                blank: "Blank canvas",
                blankHint: "Build a workflow from scratch",
                import: "Import canvas",
                importHint: "Open an exported .zip canvas file",
            },
            common: {
                nodes: "{{count}} nodes",
                stats: "{{nodes}} nodes · {{connections}} links",
                loading: "Loading…",
            ...
            templates: {
                ...
                allShown: "All {{count}} templates shown",
            ...
            library: {
                ...
                canvasUnit: "canvases",
                totalPrefix: "Total",
                totalHint: "Combined size of projects synced to the cloud",
                quotaPrefix: "Quota",
                searchPlaceholder: "Search canvases or node names",
                ...
                byName: "Sorted by name",
                bySize: "Sorted by size",
                loading: "Loading canvases…",
                empty: "No canvases yet",
                emptyHint: "Start your first workflow from a blank canvas or a template",
                notFound: "Nothing found for “{{query}}”",
                notFoundHint: "Try another keyword",
                batchLabel: "Bulk actions",
                ...
                duplicatedMany: "Created {{count}} copies",
                duplicateFailed: "Couldn’t duplicate. Please try again later.",
                copySuffix: "{{title}} copy",
                exportName: "infinite-canvas-{{count}}-projects",
                quotaFullNotice: "Canvas limit reached ({{used}} / {{limit}}). Delete canvases you no longer need to create new ones.",
                cleanUp: "Select to clean up",
            },
            preview: {
                label: "Template preview: {{title}}",
                nodes: "Nodes",
                deliverables: "Deliverables",
                platforms: "Platforms",
                general: "General",
                outputs: "Outputs",
                workflow: "Workflow",
                defaultSteps: "Reference|Prompt|Batch generate|Pick & refine|Export",
                canvasName: "Canvas name",
                full: "Canvas limit reached",
                creating: "Creating…",
                create: "Create with this template →",
            },
            palette: {
                label: "Command palette",
                placeholder: "Search canvases, templates, or type a command…",
                inputLabel: "Search canvases, templates or commands",
                groupActions: "Actions",
                groupCanvases: "Canvases",
                groupTemplates: "Templates",
                newBlank: "New blank canvas",
                ...
                noResult: "Nothing found for “{{query}}”",
                navigate: "Navigate",
                open: "Open",
        ...
        storyboard: {
            ...
            canvasGroupMeta: "{{count}} images · placed on canvas",
            shotWide: "Wide", shotFull: "Full", shotMedium: "Medium", shotClose: "Close-up", shotDetail: "Detail", shotOver: "Over-the-shoulder", statusQueued: "Queued", statusRunning: "Generating", statusSucceeded: "Complete", statusFailed: "Retry needed", statusCanceled: "Canceled", 
            retryScene: "Retry image", busy: "Another batch is generating. Wait for it to finish before retrying.", analysisFallback: "AI is unavailable; rules were used instead", generationFailed: "Batch generation failed", 
            configTitle: "Batch config", configSubtitle: "Split text into prompts or generate many images from one prompt", configShots: "{{count}} images", configConnectedBadge: "Following connected text", configSyncConnected: "Sync connected text", configSyncConnectedTitle: "Connected text changed. Syncing will discard the local text override and follow the connection again.", inputPrimary: "Primary text", inputPrimaryRequired: "Choose one primary text", inputTooManyImages: "{{count}} reference images are selected, but this batch supports at most {{max}}. Deselect some before generating.", inputShotLabel: "Image {{index}}", configPlaceholder: "One prompt per line for different images…", configSplitHint: "Click to edit each line; one image per line", configPromptAria: "Prompt", configVariantsPlaceholder: "Enter a prompt to generate several images of the same thing…", configVariantsHint: "The same prompt repeated; set the count below", configRefsPlaceholder: "Connect several images and give them one shared prompt…", configRefsPromptHint: "One image per input, all sharing this prompt", configVariantCount: "Image count", configVariantCountAria: "Image count", configCancelQueued: "Cancel queue", configStop: "Stop analysis", configStopGenerate: "Stop generation", configGenerate: "Analyze and generate", configGenerateAuto: "Generate {{count}} images", configRegenerate: "Generate {{count}} again", batchModeSplit: "Split by text", batchModeVariants: "One prompt, many variants", batchModeRefs: "One prompt, many images", promptListOpen: "Manage prompts", promptListOpenTitle: "Edit every prompt as a list", promptListOpenTitleVariants: "Edit the prompt shared by every image", promptListOpenTitleRefs: "Edit the prompt shared by every input image", promptListTitle: "Prompt list", promptListTitleVariants: "Edit prompt", promptListHint: "Numbered rows you can edit one by one", promptListHintVariants: "This prompt is repeated to generate several images of the same thing", promptListTitleRefs: "Edit prompt", promptListHintRefs: "The same prompt is applied to each input image", configRefsHint: "One image per input", refsRequired: "Connect at least one input image first", configInputImages: "Input images", configReferenceImages: "References", configMarkAsInput: "Use as input", configMarkAsReference: "Use as reference", promptListSerializeHint: "Saving writes text back using the current split rule", promptListRowPlaceholder: "Prompt {{index}}", promptListRowAria: "Prompt {{index}}", promptListAdd: "Add prompt", promptListDelete: "Delete prompt", alreadyRunning: "A batch job is already generating", scriptRequired: "Add a prompt or connect a text node first", analysisFailed: "Batch analysis failed", analysisNotReady: "Configure a text model before analyzing",
            parseMode: "Split rule", scriptTooLong: "This text exceeds {{max}} characters. Split it into multiple batches before generating.", parseModeLines: "By line", parseModeParagraphs: "By paragraph", parseModeMarkers: "By marker", parseModeProse: "By sentence", 
        ...
        workflow: {
            ...
            manualGenerationBusy: "Something is still generating. Wait for it to finish or stop it before running the workflow.",
        ...
        node: {
            node: "Node",
            untitled: "Untitled node", renameHint: "Double-click to rename the node", group: "Group", nodeCount: "{{count}} nodes", uploading: "Uploading", generating: "Generating", regenerating: "Regenerating", regeneratingProgress: "Regenerating {{completed}}/{{total}}", failed: "Generation failed", retry: "Retry", missingPlugin: "Plugin missing", missingPluginDescription: "The plugin for node type “{{type}}” is not installed or enabled", generateImage: "Generate image from text", generate: "Generate", editText: "Double-click to edit text", emptyImage: "Empty image node", emptyVideo: "Empty video node", emptyAudio: "Empty audio node", canceledTitle: "Generation canceled", interruptedTitle: "Generation interrupted", creditTitle: "Not enough credits", regenerate: "Regenerate", emptyImageHint: "Upload an image or connect a generator", emptyVideoHint: "Upload a video or connect a generator", emptyAudioHint: "Upload audio or connect a generator", audio: "Audio", batchExpanded: "Image group expanded", batchCollapsed: "Image group collapsed", createCopy: "Create copy", setPrimary: "Set as primary",
        },
        sidePanel: {
            tips: "Drag empty space to select · hold Space or right-drag to pan · Ctrl/⌘ + wheel to zoom · Delete removes the selection",
        ...
        nodeToolbar: { noPrompt: "No prompt to copy", renameTitle: "Rename node", rename: "Rename", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", delete: "Delete", retryTitle: "Generate again", saveAsset: "Save asset", downloadAudio: "Download audio", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", storyboardTitle: "Batch-generate images from text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Node size", originalSize: "Original size", mimeType: "File type", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "File size" },
