export default {
    ...
    canvas: {
        ...
        nodeToolbar: { noPrompt: "No prompt to copy", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", delete: "Delete", retryTitle: "Generate again", saveAsset: "Save asset", downloadAudio: "Download audio", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Size", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "Image size" },
    ...
    agent: {
        ...
        hosted: { heading: "AGENT", subtitle: "Built-in model", placeholder: "Describe a canvas change, for example: add a prompt node next to the selection", composerHint: "Enter to send · Shift+Enter for a new line · @ to mention nodes", applying: "Applying to canvas…", toolReading: "Reading the canvas…", toolModifying: "Modifying the canvas…", toolGenerating: "Processing generation tasks…", toolWorking: "Running {{tool}}…", applied: "Applied to canvas", failed: "Canvas agent failed", authFailed: "The chat model credential is invalid. Check the chat provider API key in admin settings.", interrupted: "The connection was interrupted. Started generation tasks remain on the canvas; check their node status before retrying.", emptyTitle: "Change the canvas in one sentence", empty: "Describe layout, nodes, or a generation flow, or start from an example below.", suggestions: { layout: "Tidy up the current canvas layout", flow: "Create an image flow from the selection", prompt: "Add a prompt node next to the selection", status: "Check current generation status" }, newChat: "New chat", linked: "Linked {{count}} connections", appliedCount: "Applied {{count}} operations", addedNodes: "Added {{count}} nodes", readCanvas: "Read the canvas", generationStatus: "Generation status", generationTriggered: "Triggered {{count}} nodes", generationSelectionSkipped: "Skipped {{count}} nodes without a valid image", generationSucceeded: "{{count}} succeeded", generationRunning: "{{count}} running", generationFailed: "{{count}} failed", generationIdle: "No generation tasks", openedPage: "Opened {{path}}", attachmentNodes: "Placed {{count}} images on the canvas", listedItems: "{{count}} items", assetAdded: "Added to assets", reasoningStandard: "Standard", reasoningExtended: "Deep", reasoningStandardWithPrice: "Standard · {{price}} credits", reasoningExtendedWithPrice: "Deep · {{price}} credits", turnPrice: "{{price}} credits/turn", turnPriceSale: "{{price}} credits/turn", generationChargedSeparately: "The Agent is billed per turn; model generation is billed separately", reasoningNotReturned: "The upstream model used reasoning tokens, but the provider did not return a reasoning summary that can be displayed.", noHistory: "This canvas has no conversation history yet", deleteChat: "Delete chat", justNow: "Just now", minutesAgo: "{{count}} min ago", yesterday: "Yesterday" },
