export default {
    ...
    canvas: {
        ...
        workflow: {
            run: "Run workflow",
            stop: "Cancel queued tasks",
            cancelQueuedCount: "Cancel {{count}} queued tasks",
            parallelRunning: "{{count}} nodes generating in parallel",
            finishingSubmitted: "Finishing {{count}} submitted tasks",
            queuedNodesCanceled: "Canceled {{count}} queued nodes; active generations will continue",
            ...
            canceled: "Queued tasks were canceled; submitted generations were allowed to finish.",
        },
        project: {
