export default {
    ...
    settingsPanels: {
        ...
        image: { title: "图像设置", quality: "质量", size: "尺寸", align16: "16 倍数对齐", align16Short: "×16", align16Hint: "输入完成后自动向上补成 16 的倍数", aspectRatio: "宽高比", resolution: "分辨率", transparent: "透明背景", transparentHint: "开启后生成无背景的透明图像（仅部分模型可用）", count: "生成张数", countShort: "张数", countUnit: "张", images: "{{count}} 张" },
