export default {
    ...
    common: {
        ...
        unsupportedImage: "无法识别该图片格式",
    },
    settingsPanels: {
        common: { auto: "自动", none: "不推理", minimal: "最低", low: "低", medium: "中", high: "高", xhigh: "极高", max: "最高" },
        image: { title: "图像设置", quality: "质量", size: "尺寸", sizeMode: "尺寸模式", ratioMode: "比例与档位", exactMode: "精确宽高", exactWidth: "宽度（px）", exactHeight: "高度（px）", exactStep: "{{step}} px 步长", align16: "16 倍数对齐", align16Short: "×16", align16Hint: "输入完成后自动向上补成 16 的倍数", aspectRatio: "宽高比", resolution: "分辨率", transparent: "透明背景", transparentHint: "开启后生成无背景的透明图像（仅部分模型可用）", count: "生成张数", countShort: "张数", countUnit: "张", images: "{{count}} 张" },
    ...
    canvas: {
        ...
        deleteAll: "删除全部",
        import: "导入画布",
        workflowTemplates: "生产工作流模板",
        templateLibrary: "模板库",
        create: "新建画布",
        createDescription: "从空白画布开始创作",
        recent: "最近项目",
        searchProjects: "搜索画布名称",
        clearSearch: "清空搜索",
        noMatchingProjects: "没有匹配的画布",
        blank: "空白画布",
        ...
        toolbar: {
            ...
            themeMode: "主题模式", light: "浅色", dark: "深色", gridStyle: "网格样式", dots: "点", lines: "线", blank: "空白", imageInfo: "图片信息", storyboard: "批量配置",
        },
        storyboard: {
            title: "批量配置", subtitle: "输入提示词，按文本拆分或同一提示词批量出图", stepsLabel: "批量流程", stepUnderstand: "理解脚本", stepReview: "审阅镜头", stepGenerate: "批量生成",
            scriptTitle: "剧本", scriptPlaceholder: "粘贴剧本、分段文本或自然语言描述…", useExample: "示例", needScript: "请输入文本", autoDetected: "将拆成 {{count}} 个镜头",
            style: "视觉风格", styleCinematic: "电影写实", styleAnime: "动画电影", styleDocumentary: "纪实质感", styleCommercial: "品牌广告", sceneCount: "镜头数", ratio: "画幅", ratioAuto: "自动", ratioLandscape: "横屏", ratioPortrait: "竖屏", ratioSquare: "方形", consistency: "角色一致", consistencyHint: "镜头间锁定主角、服装与色调", aiRefine: "润色文案", analyzing: "正在润色…", aiSource: "已润色", rulesSource: "规则拆分", sourceLabel: "文本来源", focusScene: "定位到画布",
            previewTitle: "镜头", sequenceOverview: "时间线", filmstripHint: "按时长", totalDuration: "总时长 {{duration}} 秒", shots: "镜", shotTitle: "标题", shotSummary: "描述", shotEditorTitle: "编辑第{{index}}镜", shotEditHint: "点击卡片编辑", addFirstShot: "添加第1镜", deleteShot: "删除这一镜", empty: "输入剧本后会出现镜头", emptyHint: "拆分规则决定镜头边界，AI 只润色文案", openWorkbench: "打开分镜工作台", workbenchSubtitle: "在固定工作区里编辑脚本、审核镜头并控制生成", workbenchSource: "脚本与输入", workbenchSourceHint: "这里编辑的是当前分镜脚本副本；输入连接和镜头选择在画布节点中管理。", workbenchShotDetail: "第{{index}}镜详情", workbenchDetailHint: "景别只在你明确选择后生效；未选择时保持中景。", workbenchFooterSummary: "{{shots}} 个镜头 · 已选输入 {{selected}} 个", exportPlan: "导出分镜 JSON", canvasGroupMeta: "{{count}} 个镜头 · 已落到画布",
            shotWide: "远景", shotFull: "全景", shotMedium: "中景", shotClose: "特写", shotDetail: "细节", shotOver: "过肩", shotTypeLabel: "第{{index}}镜景别", statusQueued: "排队中", statusRunning: "生成中", statusSucceeded: "已完成", statusFailed: "需重试", statusCanceled: "已取消", progress: "已完成 {{completed}} / {{total}}", partialFailure: "{{failed}} 个镜头需要重试", costHint: "将生成 {{count}} 张独立分镜图",
            generate: "生成 {{count}} 张分镜图", generating: "正在生成…", cancel: "取消生成", retryScene: "重试此镜头", retrying: "重试中…", busy: "已有另一组分镜正在生成，请等待完成后再重试", analysisFallback: "AI 暂时不可用，已使用规则解析", generationFailed: "分镜生成失败", complete: "已完成 {{count}} 张分镜图", partialCanceled: "已取消 {{canceled}} 个镜头", needsRegeneration: "{{count}} 个镜头内容已修改，请重新生成",
            configTitle: "批量配置", configSubtitle: "按文本拆分或同一提示词批量生成图片", configAutoSubtitle: "接收文本 · 拆分或复用提示词 · 输出多张图", configShots: "{{count}} 张", configScript: "提示词 / 文本", configConnectedBadge: "跟随连接文本", configLocalOverrideBadge: "本地脚本覆盖", configSyncConnected: "同步连接文本", configSyncConnectedTitle: "连接文本已更新，点击后将丢弃本地脚本覆盖并恢复跟随", inputManager: "输入管理", inputManagerSummary: "已选 {{selected}} / {{total}} · 文本 {{text}} · 图片 {{images}}", inputManagerEmpty: "暂无可用输入", inputPrimary: "主剧本", inputMakePrimary: "设为主剧本", inputPrimaryShort: "主剧本", inputPrimaryFor: "将 {{title}} 设为主剧本", inputPrimaryRequired: "请选择一个主剧本文本", inputTooManyImages: "已选 {{count}} 张参考图，当前批次最多使用 {{max}} 张，请取消选择后再生成", inputRoleLabel: "{{title}} 的参考角色", inputScopeLabel: "{{title}} 的镜头范围", inputScopeAll: "全部镜头", inputScopeSelected: "指定镜头", inputShotLabel: "第{{index}}镜", inputRoleScript: "主剧本", inputRoleContext: "补充文本", inputRoleCharacter: "人物参考", inputRoleStyle: "风格参考", inputRoleScene: "场景参考", inputRoleObject: "道具/产品", inputRoleReference: "普通参考", configScriptAria: "提示词或文本", configPlaceholder: "每行一条提示词，生成多张不同的图…", configPromptAria: "提示词", configPromptPlaceholder: "输入一条提示词，生成多张独立图片…", configRatio: "画幅", configShotCountAria: "镜头数量", configVariantCount: "生成张数", configVariantCountAria: "生成张数", configConnectedInputs: "已连接 {{count}} 个文本输入", configPasteOrConnect: "支持直接粘贴或连接文本节点", configConsistencyOn: "角色一致", configConsistencyOff: "独立镜头", configCancelQueued: "取消排队", configStop: "停止分析", configStopFormat: "停止格式化", configStopGenerate: "停止生成", configGenerate: "分析并生成", configGenerateAuto: "生成 {{count}} 张", configRegenerate: "再次生成 {{count}} 张", configCanceled: "已取消本次批量生成", configCompleteSummary: "{{title}} · {{count}} 张", configAutoDetect: "按文本结构自动识别条数", configAutoDetectShort: "自动识别", batchModeSplit: "按文本拆分", batchModeVariants: "单提示多变体", batchModeRefs: "单提示多图", batchModeSplitHint: "按行 / 段落等拆成多条提示词", batchModeVariantsHint: "同一提示词按数量生成多张独立图片", batchModeRefsHint: "同一提示词分别作用于每张输入图，参考图可另行指定", promptListOpen: "管理提示词", promptListOpenTitle: "按条编辑全部提示词", promptListOpenTitleVariants: "编辑用于多图生成的提示词", promptListOpenTitleRefs: "编辑用于单提示多图的提示词", promptListTitle: "提示词列表", promptListTitleVariants: "编辑提示词", promptListHint: "按序号排列，可直接改每一条", promptListHintVariants: "编辑后用于生成多张独立图片", promptListTitleRefs: "编辑提示词", promptListHintRefs: "同一提示词分别作用于每张输入图", configRefsHint: "按输入图张数出图", refsRequired: "请先连接至少一张输入图", configInputImages: "输入图", configReferenceImages: "参考图", configMarkAsInput: "设为输入图", configMarkAsReference: "设为参考图", configReferenceRole: "参考用途", inputRoleInput: "输入图", promptListSerializeHint: "保存时按当前拆分规则写回文本", promptListRowPlaceholder: "第 {{index}} 条提示词", promptListRowAria: "第 {{index}} 条提示词", promptListAdd: "添加一条", promptListDelete: "删除这条", promptListMoveUp: "上移", promptListMoveDown: "下移", alreadyRunning: "批量任务正在生成中", scriptRequired: "请先填写提示词或连接文本节点", analysisFailed: "批量分析失败", analysisNotReady: "请先配置可用的文本模型后再分析",
            textModel: "文本识别模型", imageModel: "生图模型", modelChange: "更换", modelCollapse: "收起", parseMode: "拆分规则", scriptTooLong: "剧本超过 {{max}} 字，请拆成多个分镜批次后再生成", parseModeLines: "按行", parseModeParagraphs: "按段落", parseModeMarkers: "按编号/标记", parseModeProse: "按句子", aiPolish: "AI 润色", aiPolishOn: "AI 润色开", aiPolishOff: "仅规则拆分", shotMetaLocation: "地点", shotMetaTime: "时间", stageFormatting: "正在按规则拆分镜头…", stageAnalyzing: "正在 AI 润色镜头…", stageGenerating: "正在生成分镜图…", stageGeneratingProgress: "正在生成分镜图 {{done}}/{{total}}",
            sectionInput: "输入", sectionModels: "模型", sectionOptions: "选项", inputChipText: "文本 ×{{count}}", inputChipPaste: "可粘贴或连接文本",
            pipelineInputTitle: "剧本输入", pipelineDetectTitle: "识别镜头", pipelineDetectSubtitle: "按文本结构拆出镜头数", pipelineDetectAction: "识别镜头", pipelineDetectStop: "停止识别", pipelineDetectHint: "连接文本后点击识别，生成镜头清单", pipelineAnalyzeTitle: "开始分析", pipelineAnalyzeSubtitle: "AI 结构化分镜计划", pipelineAnalyzeAction: "开始分析", pipelineAnalyzeHint: "先完成识别镜头，再分析得到可生图计划", pipelineGenerateTitle: "执行生图", pipelineGenerateSubtitle: "按计划批量生成镜头图", pipelineGenerateAction: "执行生图", pipelineGenerateHint: "先完成分析，再批量生成镜头图", pipelineScriptReady: "已接入剧本 · {{count}} 字", pipelineScriptMissing: "请先连接或填写剧本文本", detectComplete: "已识别 {{count}} 个镜头", detectFailed: "镜头识别失败", detectRequired: "请先在「识别镜头」节点完成识别", analyzeComplete: "已分析 {{count}} 个镜头", analyzeRequired: "请先在「开始分析」节点完成分析",
        },
        workflow: {
            run: "运行工作流",
            rerun: "重新运行工作流",
            stop: "停止工作流",
            cancelQueuedCount: "取消 {{count}} 个排队任务",
            parallelRunning: "{{count}} 个节点并行生成中",
            finishingSubmitted: "已开始的任务仍会继续执行",
            queuedNodesCanceled: "已取消 {{count}} 个排队节点",
            progress: "运行中 {{completed}}/{{total}}",
            costLabel: "完整工作流",
            empty: "画布中没有可执行的生成配置节点",
            cycle: "工作流存在循环依赖，请先调整连线",
            invalidConnection: "工作流包含配置节点之间的直接连线。请在每两个配置节点之间加入文本、图片或其他输出节点",
            graphChanged: "工作流结构已发生变化，执行已暂停。请重新检查后运行",
            nodeMissing: "工作流节点已不存在，运行已停止",
            unsupportedMedia: "节点“{{name}}”使用了暂未接入的视频或音频生成，无法运行工作流",
            notReady: "节点“{{name}}”没有已组装提示词或可用输入，请先完成配置",
            dependencyIncomplete: "节点“{{name}}”的前置节点“{{dependency}}”尚未成功，未提交生成",
            referenceMissing: "节点“{{name}}”引用的“{{reference}}”已不存在，未提交生成",
            referenceEmpty: "节点“{{name}}”引用的“{{reference}}”没有可用内容，未提交生成",
            localImageInputMissing: "图片操作节点没有连接可用的输入图片",
            localOutputCountMismatch: "图片操作结果数量与节点配置不一致",
            outputMissing: "节点“{{name}}”没有生成预期的输出节点，工作流已暂停",
            outputIncomplete: "节点“{{name}}”预期 {{expected}} 份有效结果，实际得到 {{actual}} 份，工作流已暂停",
            modelUnavailable: "节点“{{name}}”没有可用模型，请先完成模型配置",
            pricingUnavailable: "节点“{{name}}”的积分价格不明确，为避免未知扣费，工作流未启动",
            failed: "节点“{{name}}”执行失败，工作流已停止",
            failedShort: "工作流执行失败",
            failedLabel: "执行失败",
            retry: "从失败处重试",
            retryShort: "重试",
            running: "生成中",
            stopping: "停止中",
            resumed: "已恢复工作流，将从中断位置继续执行",
            preparing: "准备中",
            backgroundRunning: "工作流正在其他页面执行",
            lockedShort: "其他页面",
            runningElsewhere: "同一画布已有工作流在执行，你可以查看进度或停止它",
            completedElsewhere: "工作流已在其他页面结束，刷新即可查看最新结果",
            refreshResults: "刷新查看结果",
            syncFailed: "工作流状态同步失败，已暂停执行，请重试",
            terminalPersistenceFailed: "工作流已结束，但本地状态保存失败。你可以直接重新运行，系统会继续尝试保存",
            completed: "工作流执行完成，共运行 {{count}} 个节点",
            canceled: "工作流已停止，可以重新运行",
        },
        project: {
        ...
        sync: {
            ...
            loadFailed: "云端画布文档加载失败，请稍后重试",
        },
        createMenu: {
            fromNode: "引用该节点生成", close: "关闭", text: "文本生成", textDescription: "脚本、广告词、品牌文案", image: "上传或生成图片", video: "视频节点", audio: "音频参考", config: "配置节点", configDescription: "模型、尺寸、数量和输入顺序", select: "选择节点",
            basic: "基础", extensions: "扩展", search: "搜索节点", empty: "没有匹配的节点",
        ...
        sidePanel: {
            canvas: "画布", assets: "资产", prompts: "提示词库", recent: "最近项目", recentProjects: "最近编辑", recentMeta: "{{count}} 个节点 · {{date}}", noRecent: "暂无其他项目", noRecentHint: "新建或打开过的画布会显示在这里", resize: "调整左侧面板宽度", elements: "画布元素", select: "选择", searchNodes: "搜索节点", focusNode: "定位到节点", preview: "放大预览", workflow: "工作流", standaloneNodes: "独立节点", noNodes: "画布暂无节点", noNodesHint: "在空白处鼠标右键，或从顶部工具栏添加节点", clearAll: "取消全选", selected: "已选 {{count}}", exporting: "正在导出选中元素…", exportName: "画布元素-{{count}}个", exported: "已导出 {{count}} 个元素", exportFailed: "导出失败，请重试",
            addingAssets: "正在添加资产…", addedAssets: "已添加 {{count}} 个资产", mediaOnly: "仅支持图片或视频文件", addFailed: "添加失败，请重试", searchAssets: "搜索资产", add: "添加", noAssets: "暂无资产", noAssetsHint: "图片和顶部「我的资产」共用；上传后可随时插入画布", inserted: "插入画布", removeAssetTitle: "移除该资产？", remove: "移除", removeAsset: "移除资产", assetRemoved: "资产已移除",
            searchPrompts: "搜索提示词", noPrompts: "暂无提示词", noPromptsHint: "提示词会显示在这里，点击即可插入画布", promptCopied: "已复制提示词", copyFailed: "复制失败", loadFailedRetry: "加载失败，点击重试", noMatchingPrompts: "无匹配提示词", sourceEmpty: "该来源暂无提示词", viewDetails: "查看详情",
            filter: { image: "图片", video: "视频", text: "文本", audio: "音频", config: "配置", group: "分组" },
        },
        assetPicker: { title: "选择资产", insert: "插入", search: "搜索资产", empty: "没有资产" },
        imageTools: { copyPrompt: "复制提示词", copyPromptTitle: "复制生成该图片的提示词", reversePrompt: "反推提示词", reversePromptTitle: "创建反推提示词的文本和配置节点", replace: "替换图片", locked: "锁比例", free: "自由比例", lockTitle: "切换为等比缩放", freeTitle: "切换为自由比例", mask: "局部编辑", maskTitle: "添加蒙版遮罩后局部修改", crop: "裁剪", cropTitle: "裁剪并生成新节点", split: "切图", splitTitle: "按行列切分图片", upscale: "放大", upscaleTitle: "放大图片分辨率", removeBackground: "移除背景", removeBackgroundTitle: "用当前图片模型移除背景并生成新节点", removeBackgroundPrompt: "移除图片背景，保留主体，输出透明底。", removeBackgroundUnavailable: "当前图片模型不支持移除背景", angle: "多角度", angleTitle: "生成角度", view: "查看大图", viewTitle: "查看图片详情", more: "更多", configure: "配置快捷工具", customize: "自定义工具栏", reorder: "拖动预览条调整顺序", moveLeft: "左移", moveRight: "右移", emptyVisible: "还没有显示中的工具", showLabels: "显示按钮文字", description: "选择你想在图片节点编辑栏中使用的快捷工具。", preview: "节点预览", imageNode: "图片节点", quickTools: "快捷工具" },
        nodeToolbar: { noPrompt: "暂无可复制的提示词", renameTitle: "修改节点名称", rename: "重命名", infoTitle: "查看节点信息", info: "信息", removeTitle: "移除节点", delete: "删除", retryTitle: "重新生成", saveAsset: "存资产", downloadAudio: "下载音频", downloadVideo: "下载视频", downloadImage: "下载图片", editTextTitle: "编辑文本", editText: "编辑文字", storyboardTitle: "从文本生成分镜", decreaseFont: "减小字号", increaseFont: "增大字号", zoomOut: "缩小", zoomIn: "放大", uploadImage: "上传图片", replaceVideo: "替换视频", uploadVideo: "上传视频", replaceAudio: "替换音频", uploadAudio: "上传音频", nodeInfo: "节点信息", name: "名称", type: "类型", size: "节点尺寸", originalSize: "原图尺寸", mimeType: "文件类型", position: "位置", status: "状态", imageGroup: "图片组", imageSize: "文件大小" },
        operationNodes: { crop: "裁剪节点", cropDescription: "按固定裁剪区域输出图片", split: "切图节点", splitDescription: "按固定行列输出多张切片", upscale: "放大节点", upscaleDescription: "将输入图片放大到指定长边", angle: "多角度节点", angleDescription: "基于输入图片生成新的观察角度", anglePrompt: "基于参考图重新生成同一主体的新视角，保持主体、颜色、材质和画面风格一致，不要只做透视变形。向右旋转 45 度，水平视角，中等镜头距离，标准镜头。", reversePrompt: "反推提示词节点", reversePromptDescription: "从输入图片提取可复用的生图提示词" },
        configNode: { title: "生成配置", image: "生图", text: "文本", video: "视频", audio: "音频", prompt: "提示词", references: "参考图", videoReferences: "参考视频", audioReferences: "参考音频", items: "{{count}} 个", images: "{{count}} 张", model: "选择模型", params: "参数", emptyInputs: "尚未连接输入", compose: "组装", composed: "已组装", stop: "停止", generate: "开始生成", regenerate: "重新生成", generateWithCost: "开始生成 · {{count}} 积分", cancelQueued: "取消排队", generating: "生成中 · {{duration}}", generatedAt: "生成于 {{time}}", failedAt: "失败于 {{time}}", canceledAt: "已停止于 {{time}}", queued: "排队中", duration: "用时 {{duration}}", stopWithDuration: "停止 · {{duration}}", operationInput: "输入图片", operationParams: "处理参数", angleParams: "视角参数", configureOperation: "配置操作参数", editInstruction: "编辑分析指令", analysisInstruction: "分析要求", analysisInstructionPlaceholder: "输入需要从图片中提取的提示词信息", runOperation: "执行{{operation}}", rerunOperation: "重新执行{{operation}}", queuedOperation: "{{operation}}排队中", processingOperation: "正在{{operation}} · {{duration}}", processingOperationProgress: "正在{{operation}} · {{completed}}/{{count}} · {{duration}}", operationCompleted: "{{operation}}完成 · {{duration}}", operationFailed: "{{operation}}失败 · {{duration}}", operationReady: "{{operation}}节点已就绪", operationReadyLocal: "本地处理 · 不消耗积分", singleImageOnly: "该节点只能连接 1 张输入图片", cropSummary: "保留区域 {{width}}% × {{height}}%", splitSummary: "{{rows}} 行 × {{columns}} 列", upscaleSummary: "长边 {{size}}px · {{algorithm}}" },
        costConfirm: { eyebrow: "积分确认", title: "确认生成费用", description: "提交后冻结预计费用，完成后按实际结果结算。", caption: "本次预计 · 先冻结，完成后按实际结算", cancel: "取消", confirm: "确认生成", recharge: "去充值", skip: "不再每次确认", estimate: "本次预计", sum: "合计", credits: "积分", generation: "生图", textItem: "文本", transparentItem: "透明背景", total: "{{count}} 积分", actual: "按实际用量结算", perImage: "{{unit}} 积分 / 张", perText: "{{unit}} 积分 / 条", perRun: "{{unit}} 积分 / 次", perImageShort: "{{unit}}/张", perTextShort: "{{unit}}/条", perRunShort: "{{unit}}/次", qty: "{{unit}} × {{count}}", available: "当前可用 {{count}} 积分", remaining: "支付后剩余 {{count}} 积分", availableLabel: "可用", remainingLabel: "支付后", reading: "读取中", pending: "待计算", insufficient: "余额不足", insufficientHint: "钱包余额不足，请充值后再提交。", pricingUnavailable: "暂时读取不到单价，本次费用以服务端结算为准。", backgroundRemove: "背景移除", transparent: "透明背景 · {{unit}} 积分 / 张" },
        projectPage: {
            leaveEyebrow: "任务进行中", leaveTitle: "画布仍有任务在执行，不能直接离开", leaveDescription: "可以继续等待，或停止当前画布的 Agent、工作流、生成与分镜任务后离开。未提交上游的任务退回冻结积分；已提交上游的生成只停止接收结果，本次预留积分不退回。Agent 按已完成的画布操作结算。", leaveStay: "留在画布", leaveStopAndLeave: "停止全部并离开", leaveStopping: "正在停止…", leaveStopFailed: "未能停止全部画布任务，请重试",
            stopEyebrow: "停止确认", stopTitle: "停止当前任务？", stopDescription: "尚未提交上游的任务会停止并退回冻结积分；已提交上游的任务只停止接收结果，本次预留积分不退回，上游可能仍继续生成。", stopWorkflowDescription: "停止后续节点。尚未提交上游的任务退回冻结积分；已提交上游的任务只停止接收结果，本次预留积分不退回，上游可能仍继续生成。", stop: "确认停止", stopFailed: "停止任务失败，请重试", stopQueued: "停止后续", continue: "继续等待", mediaUnavailable: "视频和音频暂未接入", configConnection: "配置节点之间不能连接", notFound: "未找到当前画布", exporting: "正在导出当前画布…", exported: "已导出当前画布", clipboardText: "剪切板文本", clipboardImageAdded: "已从剪切板添加图片", clipboardTextAdded: "已从剪切板添加文本", clipboardUnavailable: "无法读取剪切板", noTextToSave: "没有可保存的文本", canvasText: "画布文本", noVideoToSave: "没有可保存的视频", canvasVideo: "画布视频", noImageToSave: "没有可保存的图片", canvasImage: "画布图片", emptyReverse: "图片节点为空，无法反推提示词", reverseTitle: "反推提示词", reverseConfigTitle: "反推提示词配置", splitTitle: "{{name}} {{row}}-{{column}}", splitSuccess: "已切分为 {{count}} 个子节点", localOperationResult: "{{operation}}结果", localOperationCompleted: "{{operation}}完成，共 {{count}} 个结果", localOperationFailed: "{{operation}}失败", maskResult: "局部编辑结果", maskFailed: "局部修改失败", backgroundRemoved: "背景已移除，原节点已保留", backgroundRemoveFailed: "背景移除失败", generationFailed: "生成失败", partialFailed: "部分图片生成失败", allFailed: "全部图片生成失败", retryPromptMissing: "找不到提示词，无法重试", referenceMissing: "参考图片已丢失，无法继续重试", emptyTextImage: "文本节点为空，无法生图", untitledCanvas: "未命名画布", notImplemented: "暂未实现", imageDetails: "图片详情", clearEyebrow: "清空确认", clearTitle: "清空这张画布？", clear: "清空", clearDescription: "当前画布上的节点和连线都会被移除，这个操作不能撤销。", reversePreset: "请根据参考图片反推一段适合用于 AI 生图的提示词。\n\n要求：\n1. 只输出提示词正文，不要解释。\n2. 覆盖主体、构图、风格、光线、色彩、材质、镜头和氛围。\n3. 尽量写成可直接用于生图模型的完整提示词。", maskPrompt: "只修改蒙版透明区域，其他区域保持不变。{{prompt}}", editTextPrompt: "请根据要求修改以下文本。\n\n原文：\n{{source}}\n\n修改要求：\n{{prompt}}"
        },
        reverseComposer: "参考图片：@[node:{{imageId}}]\n任务说明：@[node:{{textId}}]",
        editors: {
            reset: "重置", zoomOut: "缩小", zoomIn: "放大", loading: "读取中", unknown: "未知", cancel: "取消",
            angleTitle: "AI 多角度", angleDescription: "左侧只预览方向，结果会基于原图重新生成", angleDrag: "拖动调角度 · 滚轮调距离", angleNear: "近", angleMid: "中", angleFar: "远", horizontal: "左右角度", pitch: "俯仰角度", distance: "镜头距离", lens: "广角镜头", standard: "标准", wide: "广角", aiGenerate: "AI 生成",
            upscaleTitle: "图片放大", scale: "{{value}}×", source: "源图", targetPixels: "目标像素", maxReached: "图片已达到 4K，无需放大", targetReached: "图片已达到当前目标像素，无需放大", algorithm: "放大算法", outputSize: "输出尺寸", upscale: "生成放大图", high: "高清插值", highDescription: "适合照片和细节图", bilinear: "双线性", bilinearDescription: "平滑、速度快", nearest: "最近邻", nearestDescription: "适合像素风格",
            cropTitle: "裁剪图片", adjustCrop: "调整裁剪框", cropHint: "双指或滚轮平移 · ⌃滚轮缩放 · 空格拖动", cropSize: "裁剪尺寸 {{size}}", ratio: "比例 {{ratio}}", original: "原图 {{width}} x {{height}}", confirmCrop: "确认裁剪", free: "自由", fixed: "固定", originalMode: "原图",
            maskTitle: "局部遮罩编辑", maskHint: "滚轮缩放 · 中键或空格+左键拖动画面 · Alt+左/右键横拖调笔刷 · Ctrl/Cmd+Z 撤回 · Ctrl/Cmd+Shift+Z 重做", panKey: "空格", panHint: "拖动平移", brush: "画笔", erase: "擦除", brushTitle: "画笔 (B)", eraseTitle: "擦除 (E)，按住右键也可擦除", resetMaskTitle: "清空遮罩", undoMaskTitle: "撤回局部涂抹 (Ctrl/Cmd+Z)", undoMask: "撤回局部涂抹", redoMaskTitle: "重做局部涂抹 (Ctrl/Cmd+Shift+Z)", redoMask: "重做局部涂抹", brushSize: "笔刷大小", editInstructions: "修改要求", maskPlaceholder: "例如：把选中区域改成金属材质，保持原图光影", maskPromptRequired: "请输入修改要求", maskRequired: "请先涂抹局部区域", aiEdit: "AI 修改", submitShortcut: "⌘↵",
        ...
        promptPanel: { video: "描述要生成的视频内容", audio: "描述要生成的音频内容", image: "描述要生成的图片内容", text: "请输入你想要生成的文本内容", editImage: "请输入你想要把这张图修改成什么", editText: "请输入你想要将本段文本修改成什么", expandEditor: "放大编辑", collapseEditor: "收起编辑", editorTitle: "编辑提示词", charCount: "{{count}} 字", stopGeneration: "停止生成", generate: "生成", stop: "停止" },
        promptLibrary: { title: "提示词库", search: "搜索提示词", category: "分类", tag: "标签", use: "使用", empty: "没有找到匹配的提示词", emptyHint: "换个关键词或筛选条件试试", loadFailed: "获取提示词失败", total: "共 {{count}} 条" },
        ...
        controls: { ratio: "比例", duplicate: "复制", delete: "删除", deleteConnections: "删除 {{count}} 条连线", images: "{{count}} 张", reasoning: "推理" },
        generation: { interrupted: "页面刷新后生成已中断，请重新生成。", canceled: "生成已取消，请重新生成。", front: "正面视角", rotateRight: "向右旋转 {{angle}} 度", rotateLeft: "向左旋转 {{angle}} 度", level: "水平视角", topDown: "俯视 {{angle}} 度", lowAngle: "仰视 {{angle}} 度", angleLabel: "AI 多角度：{{horizontal}}，{{pitch}}，镜头距离 {{distance}}，{{lens}}镜头", anglePrompt: "基于参考图重新生成同一主体的新视角，保持主体、颜色、材质和画面风格一致，不要只做透视变形。{{angle}}。" },
        agentOps: { add_node: "新增节点", update_node: "更新节点", delete_node: "删除节点", delete_connections: "删除连线", connect_nodes: "连接", create_generation_flow: "创建生图流程", create_graph: "搭建工作流", arrange_nodes: "整理布局", move_nodes: "移动节点", resize_node: "调整尺寸", set_viewport: "调整视图", select_nodes: "选择节点", run_generation: "触发生成" },
    ...
    config: {
        ...
        localStorage: {
            ...
            refresh: "刷新统计",
            readFailed: "读取本地存储失败",
            stores: { appState: "应用状态", images: "图片文件", media: "音视频文件", agentMessages: "Agent 消息", promptCache: "提示词缓存" },
        },
        promptSources: {
            add: "新增来源",
            deleteTitle: "删除「{{name}}」？",
    ...
    agent: {
        canvasHistoryTool: { undoTitle: "撤销 Agent 操作", redoTitle: "重做 Agent 操作", undone: "已撤销上一次 Agent 画布操作", redone: "已重做上一次 Agent 画布操作" },
        generationSettingsTool: { title: "更新生成参数", updated: "已更新 {{count}} 个生成节点", unchanged: "{{count}} 个生成节点已是目标参数" },
        ...
        siteTools: { webSearch: "联网搜索", canvasList: "画布列表", workflowTemplateList: "工作流模板", workflowTemplateInspect: "检查工作流模板", workflowTemplateCreate: "从模板创建画布", workflowPreflight: "工作流运行预检", generationStatus: "生成任务状态", promptSearch: "搜索提示词", assetList: "资产列表", assetAdd: "添加资产", unknownTool: "未知工具：{{name}}", canvasLoading: "画布还在加载中，请稍后重试", canvasHint: "用 site_navigate 跳转 /canvas/{id} 打开对应画布", workflowTemplateIdRequired: "请使用模板列表返回的精确 templateId", workflowTemplateAuthRequired: "请先登录后再从模板创建画布", assetsLoading: "资产还在加载中，请稍后重试", assetTitleRequired: "请提供资产标题 title", textContentRequired: "kind=text 时需要提供 content 文本内容", imageUrlRequired: "kind=image 时需要提供 imageUrl（图片地址或 dataURL）", imageReadFailed: "无法读取该图片地址，请改用 dataURL 或可跨域访问的图片链接", assetKindUnsupported: "assets_add 仅支持 kind=text 或 kind=image" },
        ...
        selection: { selectedNodes: "已选 {{count}} 个节点", selectedNodesTitle: "当前选中的节点", viewSelectedNodes: "查看全部选中节点" },
        composer: { removeImage: "移除图片", removeSkill: "移除 Skill", uploadImage: "上传图片", stop: "停止", send: "发送", credits: "积分", settings: "模型与选项", settingsOpen: "打开模型与选项", modelSection: "模型", reasoningSection: "推理", permissionSection: "权限", toolsSection: "写入权限", model: "模型：{{model}}", selectModel: "选择 Codex 模型，当前为 {{model}}", selectChatModel: "选择模型，当前为 {{model}}", searchModel: "搜索模型", noMatchingModel: "没有匹配的模型", reasoning: "思考程度：{{effort}}", selectReasoning: "选择思考程度，当前为 {{effort}}", effortCount: "{{count}} 档", permissionLabel: "权限：{{mode}}", selectPermission: "选择 Codex 权限模式，当前为 {{mode}}", effort: { none: "不推理", minimal: "最低", low: "轻度", medium: "中", high: "高", xhigh: "极高", max: "最高", ultra: "Ultra" }, permission: { request: "请求批准", requestDescription: "编辑工作区外文件或联网时始终询问", automatic: "自动审查", automaticDescription: "由 Codex 审查风险操作，必要时再询问", full: "完全访问权限", fullShort: "完全访问", fullDescription: "不受限制地访问网络和本机文件" }, tools: { label: "工具确认：{{mode}}", manual: "手动确认", manualHint: "写入前询问", manualDescription: "Agent 执行画布写入前会请求确认", automatic: "自动确认", automaticHint: "直接写入画布", automaticDescription: "Agent 会自动执行画布写入操作", select: "选择工具确认模式，当前为 {{mode}}" }, mentions: { selectSkill: "选择 Skill", selectResource: "引用画布素材", loadingSkills: "正在读取 Skill…", noSkills: "没有匹配的已启用 Skill", noResources: "当前画布没有匹配的可引用素材", previewUnavailable: "当前无法预览该素材", referenceLabel: "引用{{kind}}：{{title}}", resourceMissing: "画布素材“{{title}}”已不存在", imageReadFailed: "无法读取画布图片“{{title}}”", kind: { image: "图片", video: "视频", audio: "音频", text: "文本" } } },
        ...
        hosted: { reviewOutputs: "验收生成结果", reviewing: "正在等待任务完成并验收结果…", heading: "AGENT", subtitle: "内置模型", placeholder: "描述你想改的画布，例如：在选中节点旁边加一个提示词", composerHint: "Enter 发送 · Shift+Enter 换行 · @ 引用节点", applying: "正在应用到画布…", webSearching: "正在联网检索…", webSearchCompleted: "联网检索完成，找到 {{count}} 个来源", webSearchFailed: "联网搜索失败", toolReading: "正在读取画布…", toolModifying: "正在修改画布…", toolGenerating: "正在处理生成任务…", toolWorking: "正在执行{{tool}}…", applied: "已应用到画布", failed: "画布助手处理失败", authFailed: "对话模型认证失效，请在后台检查对话模型服务商的 API Key。", interrupted: "连接意外中断。已启动的生成任务仍会保留在画布中，请查看节点状态后重试。", emptyTitle: "从一句话改画布", empty: "描述你想创建或修改的画布内容。", suggestions: { layout: "整理当前画布的节点布局", flow: "根据选中节点创建生图流程", prompt: "在选中节点旁边加一个提示词", status: "查看当前生成任务状态" }, newChat: "新对话", linked: "已连线 {{count}} 条", appliedCount: "已执行 {{count}} 项操作", ignoredOps: "已忽略 {{count}} 项无效操作", noValidOps: "未应用操作，已返回最新画布状态", addedNodes: "新增 {{count}} 个节点", readCanvas: "已读取画布", generationStatus: "生成状态", generationTriggered: "已触发 {{count}} 个节点生成", generationSelectionSkipped: "跳过 {{count}} 个非有效图片节点", generationSucceeded: "成功 {{count}}", generationRunning: "进行中 {{count}}", generationFailed: "失败 {{count}}", generationUnknown: "{{count}} 个任务状态暂未确认，未自动重新生成", generationIdle: "暂无生成任务", openedPage: "已打开 {{path}}", attachmentNodes: "已将 {{count}} 张图片放到画布", listedItems: "共 {{count}} 条", workflowTemplateInspected: "已读取「{{title}}」：{{nodes}} 个节点，{{workflows}} 个工作流", workflowTemplateCreated: "已从模板创建「{{title}}」", workflowPreflight: "预检 {{nodes}} 个节点，预计 {{price}} 积分（付费 {{paid}}，免费 {{free}}）", assetAdded: "已加入素材", reasoningStandard: "标准", reasoningExtended: "深度", reasoningStandardWithPrice: "标准 · {{price}}积分", reasoningExtendedWithPrice: "深度 · {{price}}积分", turnPrice: "{{price}} 积分/轮", turnPriceSale: "{{price}} 积分/轮", generationChargedSeparately: "Agent 按轮计费，模型生成费用另计", reasoningNotReturned: "上游模型消耗了推理 token，但服务商没有返回可展示的推理摘要。", noHistory: "这个画布还没有对话记录", deleteChat: "删除对话", justNow: "刚刚", minutesAgo: "{{count}} 分钟前", yesterday: "昨天" },
        visual: { inspection: "已检查 {{count}} 张真实图片，发现 {{duplicates}} 组重复或高度相似关系", inspectTool: "检查真实图片" },
        ...
        message: { close: "关闭", copied: "已复制", copyCode: "复制代码", copyLink: "复制链接", externalWarning: "即将打开以下外部链接，请确认链接可信。", openExternal: "打开外部链接？", continueOpen: "继续打开", revealed: "已在文件管理器中定位", openLocalFailed: "无法打开本地文件", openLocal: "打开本地文件？", localDescription: "将在本机文件管理器中定位该路径，不会通过浏览器打开。", externalDescription: "即将打开以下外部链接，请确认链接可信。", pathCopied: "路径已复制", linkCopied: "链接已复制", copyPath: "复制路径", showInFolder: "在文件管理器中显示", toolCall: "工具调用", awaitingConfirmation: "等待确认", reject: "拒绝执行", approve: "批准执行", networkApproval: "请求网络访问", fileApproval: "请求编辑文件", permissionApproval: "请求扩展权限", commandApproval: "请求执行命令", decline: "拒绝", allowOnce: "允许一次", allowSession: "本会话允许", thinking: "正在思考", reasoningTokens: "{{count}} 推理 token", commandsRunning: "正在执行 {{count}} 条命令", commandRunning: "正在执行命令", commandsCompleted: "已执行 {{count}} 条命令{{failed}}", commandsFailed: " · {{count}} 条失败", failed: "执行失败", running: "进行中", completed: "已完成", command: "命令", slowResponse: "响应时间较长，但任务仍在运行。可以继续等待，或点击输入框右侧的停止按钮结束本轮。", waitingSeconds: "已等待 {{seconds}} 秒", waitingMinutes: "已等待 {{minutes}} 分 {{seconds}} 秒", files: "涉及文件", errorInfo: "错误信息", output: "运行输出", viewLarge: "点击查看大图", attachmentPreview: "图片附件预览", noEffect: "未生效", canceled: "已取消", recorded: "已记录", stopped: "已停止", finished: "已结束", pending: "待处理" },
        ...
        eventExtra: { toolNamed: "调用工具：{{name}}", toolOperation: "工具操作", targetPage: "目标页面", searchContent: "搜索内容", textContent: "文本内容", operationContent: "操作内容", imageCount: "图片数量", tools: { generateImage: "生成图片", viewImage: "查看图片", executeCommand: "执行命令", editFiles: "修改文件", searchWeb: "搜索资料", canvasOps: "画布操作", readCanvas: "读取画布", readSelection: "读取选区", findNodes: "查找节点", inspectNodes: "检查节点", focusNodes: "定位节点", duplicateSelection: "复制选中节点", imageOperation: "创建图片操作节点", replaceWorkflowInput: "替换工作流输入", runDownstream: "运行受影响下游", listAgentHistory: "查看 Agent 历史", createCheckpoint: "创建检查点", restoreCheckpoint: "恢复检查点", restoreTransaction: "恢复历史事务", validateWorkflow: "校验工作流", stopWorkflow: "停止工作流", resumeWorkflow: "恢复工作流", retryFailedNodes: "重试失败节点", exportSnapshot: "导出快照", createNode: "创建节点", addAttachments: "添加附件图片", createText: "创建文本", createTexts: "批量创建文本", createConfig: "创建生成配置", createImageFlow: "创建生图流程", createGenerationFlow: "创建生成流程", generateText: "生成文本", generateVideo: "生成视频", generateAudio: "生成音频", updateNode: "更新节点", updateText: "更新文本", moveNodes: "移动节点", resizeNode: "调整节点尺寸", deleteNodes: "删除节点", connectNodes: "连接节点", selectNodes: "选择节点", setViewport: "调整视口", runGeneration: "触发生成", openPage: "打开页面" } },
        eventMore: { toolRunning: "{{action}}中…", openedRoute: "已打开{{route}}", canvasCount: "共 {{count}} 个画布", workflowTemplateCount: "找到 {{count}} 个工作流模板", workflowTemplateInspected: "已读取工作流模板结构", workflowTemplateCreated: "已从模板创建新画布", workflowPreflight: "预检 {{count}} 个节点，预计 {{price}} 积分", promptCount: "找到 {{count}} 条提示词", assetCount: "共 {{count}} 个资产", assetAdded: "已加入我的素材", generationStatus: "共 {{total}} 个任务，排队 {{queued}}，运行中 {{running}}，成功 {{succeeded}}，失败 {{failed}}", canvasRead: "已读取当前画布内容", selectionRead: "已读取当前选中内容", textNodes: "{{count}} 个文本", imageNodes: "{{count}} 张图片", configNodes: "{{count}} 个配置", videoNodes: "{{count}} 个视频", audioNodes: "{{count}} 个音频", groupNodes: "{{count}} 个分组", otherNodes: "{{count}} 个其他节点", connections: "{{count}} 条连线", emptyCanvas: "当前画布为空", executeTool: "执行{{tool}}", thinking: "正在思考...", operationRunning: "{{operation}}正在进行...", organizingCanvas: "画布已读取，Codex 正在整理结果...", operationCompleted: "{{operation}}已完成，Codex 正在继续处理...", attachmentPrompt: "请处理上传的图片附件。", routes: { home: "首页", canvas: "画布页面", canvasProject: "指定画布", assets: "我的素材", config: "配置页面" } },
        runtime: {
