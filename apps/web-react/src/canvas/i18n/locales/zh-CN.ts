export default {
    ...
    canvas: {
        ...
        toolbar: {
            ...
            themeMode: "主题模式", light: "浅色", dark: "深色", gridStyle: "网格样式", dots: "点", lines: "线", blank: "空白", imageInfo: "图片信息", storyboard: "智能分镜",
        },
        storyboard: {
            title: "智能分镜工作台", subtitle: "把一段文本拆成可生成、可编辑的镜头序列", stepsLabel: "分镜流程", stepUnderstand: "理解脚本", stepReview: "审阅镜头", stepGenerate: "批量生成",
            scriptTitle: "故事文本", scriptPlaceholder: "粘贴故事、脚本或产品文案，AI 会识别场景、动作和镜头语言…", useExample: "使用示例", needScript: "请输入文本", autoDetected: "已识别 {{count}} 个镜头",
            style: "视觉风格", styleCinematic: "电影写实", styleAnime: "动画电影", styleDocumentary: "纪实质感", styleCommercial: "品牌广告", sceneCount: "镜头数", ratio: "画幅比例", ratioLandscape: "横屏", ratioPortrait: "竖屏", ratioSquare: "方形", consistency: "角色与风格连续性", consistencyHint: "锁定主角、服装、道具和色彩基调", aiRefine: "AI 精修分镜", analyzing: "正在理解…", aiSource: "AI 结构化", rulesSource: "规则已识别", sourceLabel: "文本来源", focusScene: "定位到画布",
            previewTitle: "镜头序列", sequenceOverview: "时间线", filmstripHint: "按时长", totalDuration: "总时长 {{duration}} 秒", shots: "个镜头", shotTitle: "镜头标题", shotSummary: "镜头描述", empty: "输入文本后开始拆解", emptyHint: "识别场景、动作与镜头语言", exportPlan: "导出分镜 JSON", canvasGroupMeta: "{{count}} 个镜头 · 已落到画布",
            shotWide: "远景", shotFull: "全景", shotMedium: "中景", shotClose: "特写", shotDetail: "细节", shotOver: "过肩", statusQueued: "排队中", statusRunning: "生成中", statusSucceeded: "已完成", statusFailed: "需重试", statusCanceled: "已取消", progress: "已完成 {{completed}} / {{total}}", partialFailure: "{{failed}} 个镜头需要重试", costHint: "将生成 {{count}} 张独立分镜图",
        ...
        projectPage: {
            leaveEyebrow: "Agent 执行中", leaveTitle: "Agent 正在操作当前画布，不能直接离开", leaveDescription: "可以继续等待，或停止当前画布任务后离开。未提交上游的任务退回冻结积分；已提交上游的生成只停止接收结果，本次预留积分不退回。Agent 按已完成的画布操作结算。", leaveStay: "留在画布", leaveStopAndLeave: "停止全部并离开", leaveStopping: "正在停止…", leaveStopFailed: "未能停止全部画布任务，请重试",
