export default {
    ...
    canvas: {
        ...
        workflow: {
            ...
            finishingSubmitted: "正在完成 {{count}} 个已提交任务",
            queuedNodesCanceled: "已取消 {{count}} 个排队节点；生成中的任务不会被中断",
            ...
            canceled: "已取消排队任务；已提交生成的任务已继续完成",
        },
        project: {
