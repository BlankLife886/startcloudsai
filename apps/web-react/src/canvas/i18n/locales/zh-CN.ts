export default {
    ...
    canvas: {
        ...
        sidePanel: {
            ...
            addingAssets: "正在添加资产…", addedAssets: "已添加 {{count}} 个资产", mediaOnly: "仅支持图片或视频文件", addFailed: "添加失败，请重试", searchAssets: "搜索资产", add: "添加", noAssets: "暂无资产", noAssetsHint: "上传图片或视频，之后可以随时插入画布", inserted: "插入画布", removeAssetTitle: "移除该资产？", remove: "移除", removeAsset: "移除资产", assetRemoved: "资产已移除",
        ...
        agentOps: { add_node: "新增节点", update_node: "更新节点", delete_node: "删除节点", delete_connections: "删除连线", connect_nodes: "连接", create_generation_flow: "创建生图流程", create_graph: "搭建工作流", move_nodes: "移动节点", resize_node: "调整尺寸", set_viewport: "调整视图", select_nodes: "选择节点", run_generation: "触发生成" },
    ...
    agent: {
        ...
        hosted: { subtitle: "内置模型", placeholder: "描述你想改的画布，例如：在选中节点旁边加一个提示词", applying: "正在应用到画布…", applied: "已应用到画布", failed: "画布助手处理失败", authFailed: "对话模型认证失效，请在后台检查对话模型服务商的 API Key。", empty: "用内置模型操作画布，不用连接 Codex", newChat: "新对话", linked: "已连线 {{count}} 条", appliedCount: "已执行 {{count}} 项操作", addedNodes: "新增 {{count}} 个节点", readCanvas: "已读取画布", generationStatus: "生成状态", generationTriggered: "已触发 {{count}} 个节点生成", generationSucceeded: "成功 {{count}}", generationRunning: "进行中 {{count}}", generationFailed: "失败 {{count}}", generationIdle: "暂无生成任务", openedPage: "已打开 {{path}}", attachmentNodes: "已将 {{count}} 张图片放到画布", listedItems: "共 {{count}} 条", assetAdded: "已加入素材", reasoningStandard: "标准", reasoningExtended: "深度", reasoningStandardWithPrice: "标准 · {{price}}积分", reasoningExtendedWithPrice: "深度 · {{price}}积分", turnPrice: "{{price}}积分/轮", generationChargedSeparately: "Agent 按轮计费，模型生成费用另计", reasoningNotReturned: "上游模型消耗了推理 token，但服务商没有返回可展示的推理摘要。" },
