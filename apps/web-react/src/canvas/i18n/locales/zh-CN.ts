export default {
    ...
    agent: {
        ...
        hosted: { heading: "AGENT", subtitle: "内置模型", placeholder: "描述你想改的画布，例如：在选中节点旁边加一个提示词", composerHint: "Enter 发送 · Shift+Enter 换行 · @ 引用节点", applying: "正在应用到画布…", webSearching: "正在联网检索…", webSearchCompleted: "联网检索完成，找到 {{count}} 个来源", webSearchFailed: "联网搜索失败", toolReading: "正在读取画布…", toolModifying: "正在修改画布…", toolGenerating: "正在处理生成任务…", toolWorking: "正在执行{{tool}}…", applied: "已应用到画布", failed: "画布助手处理失败", authFailed: "对话模型认证失效，请在后台检查对话模型服务商的 API Key。", interrupted: "连接意外中断。已启动的生成任务仍会保留在画布中，请查看节点状态后重试。", emptyTitle: "从一句话改画布", empty: "描述你想创建或修改的画布内容。", suggestions: { layout: "整理当前画布的节点布局", flow: "根据选中节点创建生图流程", prompt: "在选中节点旁边加一个提示词", status: "查看当前生成任务状态" }, newChat: "新对话", linked: "已连线 {{count}} 条", appliedCount: "已执行 {{count}} 项操作", ignoredOps: "已忽略 {{count}} 项无效操作", noValidOps: "未应用操作，已返回最新画布状态", addedNodes: "新增 {{count}} 个节点", readCanvas: "已读取画布", generationStatus: "生成状态", generationTriggered: "已触发 {{count}} 个节点生成", generationSelectionSkipped: "跳过 {{count}} 个非有效图片节点", generationSucceeded: "成功 {{count}}", generationRunning: "进行中 {{count}}", generationFailed: "失败 {{count}}", generationIdle: "暂无生成任务", openedPage: "已打开 {{path}}", attachmentNodes: "已将 {{count}} 张图片放到画布", listedItems: "共 {{count}} 条", workflowTemplateInspected: "已读取「{{title}}」：{{nodes}} 个节点，{{workflows}} 个工作流", workflowTemplateCreated: "已从模板创建「{{title}}」", workflowPreflight: "预检 {{nodes}} 个节点，预计 {{price}} 积分（付费 {{paid}}，免费 {{free}}）", assetAdded: "已加入素材", reasoningStandard: "标准", reasoningExtended: "深度", reasoningStandardWithPrice: "标准 · {{price}}积分", reasoningExtendedWithPrice: "深度 · {{price}}积分", turnPrice: "{{price}} 积分/轮", turnPriceSale: "{{price}} 积分/轮", generationChargedSeparately: "Agent 按轮计费，模型生成费用另计", reasoningNotReturned: "上游模型消耗了推理 token，但服务商没有返回可展示的推理摘要。", noHistory: "这个画布还没有对话记录", deleteChat: "删除对话", justNow: "刚刚", minutesAgo: "{{count}} 分钟前", yesterday: "昨天" },
