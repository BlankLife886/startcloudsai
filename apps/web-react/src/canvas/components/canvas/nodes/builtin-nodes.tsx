...
const BUILTIN_DEFINITIONS: CanvasNodeDefinition[] = [
    { type: CanvasNodeType.Text, title: i18n.t("assets.kinds.text"), description: i18n.t("canvas.createMenu.textDescription"), icon: <FileText className={iconClass} />, minimapColor: undefined, resource: builtinResource },
    { type: CanvasNodeType.Image, title: i18n.t("assets.kinds.image"), description: i18n.t("canvas.createMenu.image"), icon: <ImageIcon className={iconClass} />, minimapColor: "#10b981", keepAspectRatio: (node: CanvasNodeData) => !node.metadata?.freeResize, resource: builtinResource },
    { type: CanvasNodeType.Video, title: i18n.t("assets.kinds.video"), description: i18n.t("canvas.createMenu.video"), icon: <Video className={iconClass} />, minimapColor: "#f97316", keepAspectRatio: () => true, resource: builtinResource },
    { type: CanvasNodeType.Audio, title: i18n.t("assets.kinds.audio"), description: i18n.t("canvas.createMenu.audio"), icon: <Music2 className={iconClass} />, minimapColor: "#a855f7", resource: builtinResource },
    { type: CanvasNodeType.Config, title: i18n.t("canvas.configNode.title"), description: i18n.t("canvas.createMenu.configDescription"), icon: <Settings2 className={iconClass} />, minimapColor: "#60a5fa" },
    { type: CanvasNodeType.Group, title: i18n.t("canvas.node.group"), description: i18n.t("canvas.createMenu.groupDescription"), icon: <Group className={iconClass} />, minimapColor: "#94a3b8" },
].map((def) => {
