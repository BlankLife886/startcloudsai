...
const toolTranslationKeys: Record<string, string> = {
    ...
    canvas_find_nodes: "findNodes",
    canvas_inspect_nodes: "inspectNodes",
    canvas_inspect_visuals: "inspectNodes",
    canvas_focus_nodes: "focusNodes",
    canvas_duplicate_selection: "duplicateSelection",
    canvas_create_image_operation: "imageOperation",
    canvas_replace_workflow_input: "replaceWorkflowInput",
    canvas_run_downstream: "runDownstream",
    canvas_list_agent_history: "listAgentHistory",
    canvas_create_checkpoint: "createCheckpoint",
    canvas_restore_checkpoint: "restoreCheckpoint",
    canvas_restore_agent_transaction: "restoreTransaction",
    canvas_export_snapshot: "exportSnapshot",
    canvas_create_attachment_nodes: "addAttachments",
    canvas_update_generation_settings: "updateNode",
    canvas_undo_last_action: "canvasOps",
    canvas_redo_last_action: "canvasOps",
    canvas_run_generation: "runGeneration",
    canvas_regenerate_selection: "runGeneration",
    canvas_generation_status: "runGeneration",
    canvas_run_workflow: "runWorkflow",
    canvas_workflow_status: "workflowStatus",
    canvas_validate_workflow: "validateWorkflow",
    canvas_plan_workflow_run: "planWorkflowRun",
    canvas_stop_workflow: "stopWorkflow",
    canvas_resume_workflow: "resumeWorkflow",
    canvas_retry_failed_nodes: "retryFailedNodes",
