            ...
            <div className="shrink-0 border-b px-4 py-3" style={{ borderColor: theme.node.stroke }}>
                <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <Dropdown trigger={["click"]} placement="bottomRight" open={createMenuOpen} onOpenChange={setCreateMenuOpen} overlayClassName="canvas-float-menu" disabled={!connected || !clientId || Boolean(generatingSource)} menu={createMenu}>
