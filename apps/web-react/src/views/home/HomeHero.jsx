...
export function HomeHero() {
  ...
  return (
    <HomeBannerCarousel hero previewItems={previewItems} renderContent={(slide) =>
      <div className="home-shell home-hero__inner">
        ...
        {slide.linkUrl && <div className="home-hero__links" data-home-enter>
          {slide.isLinkVisible && (slide.linkUrl.startsWith("/") && !slide.newTab
