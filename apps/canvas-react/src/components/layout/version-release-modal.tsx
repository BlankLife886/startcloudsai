...
type VersionReleaseModalProps = {
    ...
    checking: boolean;
    checkLatestRelease: (showMessage?: boolean) => Promise<boolean>;
};

export function VersionReleaseModal({ open, onClose, currentVersion, latestVersion, releases, checking, checkLatestRelease }: VersionReleaseModalProps) {
    return (
        <Modal title="版本更新" open={open} width={680} centered footer={null} onCancel={onClose}>
