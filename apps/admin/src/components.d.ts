...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    SubscriptionAuditTrail: typeof import('./components/SubscriptionAuditTrail.vue')['default']
    ...
    UserBillingPanel: typeof import('./components/UserBillingPanel.vue')['default']
