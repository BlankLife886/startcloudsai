...
const CODE_MESSAGES: Record<string, string> = {
  ...
  origin_not_allowed: "当前后台地址未被服务端允许，请检查 ALLOWED_ORIGINS",
  ...
  submission_daily_limit: "已达到今日投稿数量上限",
  bad_request: "请求参数错误",
  code_invalid: "兑换码不存在或无效",
  code_redeemed: "兑换码已被使用",
  code_expired: "兑换码已过期",
  code_disabled: "兑换码已被禁用",
  plan_in_use: "套餐已有历史订单或订阅，只能下架，不能删除",
  builtin_source_protected: "内置数据源受保护，不可删除",
  builtin_category_protected: "内置分类不可删除，可以停用或改名",
  not_found: "资源不存在",
