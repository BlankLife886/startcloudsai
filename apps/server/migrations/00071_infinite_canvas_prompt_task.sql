...
-- +goose Down
UPDATE prompt_library SET task_type = 't2i' WHERE task_type = 'infinite_canvas';
UPDATE prompt_sources SET task_type = 't2i' WHERE task_type = 'infinite_canvas';
UPDATE prompt_import_items SET task_type = 't2i' WHERE task_type = 'infinite_canvas';
