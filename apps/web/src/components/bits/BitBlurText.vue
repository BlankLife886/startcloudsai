<template>
  <p ref="rootRef" class="bit-blur-text" :class="className">
    <Motion
...
const elements = computed(() =>
  props.animateBy === 'words' ? String(props.text).split(' ') : String(props.text).split(''),
)
