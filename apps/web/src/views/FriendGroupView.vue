...
import highFiveArt from '@/assets/incentives/group-highfive.png'
  ...
  <main class="group-page">
    <section class="group-hero">
      ...
      <div class="group-shell group-hero__inner">
        ...
        <div class="group-hero__asset" aria-hidden="true">
...
.group-hero__asset img {
  width: min(84%, 560px);
  mix-blend-mode: multiply;
  -webkit-mask-image: radial-gradient(78% 88% at 50% 52%, #000 58%, transparent 99%);
  mask-image: radial-gradient(78% 88% at 50% 52%, #000 58%, transparent 99%);
}
.group-panel {
  position: relative;
  z-index: 3;
