...
/* Ornate game navigation rail shared by both appearance modes. */
.game-art-studio,
.game-art-studio.is-light {
...
.game-art-studio.is-light .ga-rail {
  ...
  border-color: rgba(126, 105, 70, 0.58);
  border-radius: 7px 7px 14px 14px;
  background:
    radial-gradient(circle at 50% 0%, rgba(48, 101, 139, 0.26), transparent 34%),
    linear-gradient(90deg, rgba(5, 11, 16, 0.48), transparent 18% 82%, rgba(5, 11, 16, 0.48)),
    #101d28;
  box-shadow:
    inset 0 0 0 1px rgba(123, 162, 187, 0.14),
    inset 4px 0 10px rgba(193, 155, 91, 0.05),
    inset -4px 0 10px rgba(193, 155, 91, 0.05),
    inset 0 0 24px rgba(4, 10, 15, 0.74),
    0 16px 42px rgba(6, 12, 17, 0.2);
  color-scheme: dark;
}

.game-art-studio .ga-rail::before,
.game-art-studio.is-light .ga-rail::before {
  content: '';
  position: absolute;
  z-index: 0;
  inset: 6px;
  border: 1px solid rgba(107, 143, 166, 0.18);
  border-radius: 5px;
  box-shadow:
    inset 1px 0 rgba(193, 155, 91, 0.16),
    inset -1px 0 rgba(193, 155, 91, 0.16);
  pointer-events: none;
}

.game-art-studio .ga-rail::after,
.game-art-studio.is-light .ga-rail::after {
  content: '';
  position: absolute;
  z-index: 2;
  top: 7px;
  ...
  width: 14px;
  height: 14px;
  border: 1px solid rgba(167, 140, 88, 0.62);
  background: #172a38;
  box-shadow:
    inset 0 0 0 2px #101d28,
    0 0 0 1px rgba(54, 92, 116, 0.34),
    0 0 10px rgba(77, 161, 217, 0.24);
  pointer-events: none;
  transform: translateX(-50%) rotate(45deg);
}

.game-art-studio .ga-rail button,
.game-art-studio.is-light .ga-rail button {
  z-index: 1;
  width: 92px;
  height: clamp(76px, 10.5vh, 108px);
  gap: 7px;
  color: #899dac;
  background-image: linear-gradient(
    90deg,
    transparent 10%,
    rgba(63, 94, 116, 0.42) 28%,
    rgba(63, 94, 116, 0.42) 72%,
    transparent 90%
  );
...
.game-art-studio .ga-rail button i,
.game-art-studio.is-light .ga-rail button i {
  width: 34px;
  height: 34px;
  color: #94a9b9;
  font-size: 23px;
  filter: drop-shadow(0 2px 3px rgba(0, 0, 0, 0.44));
}

.game-art-studio .ga-rail button:not(.active) i::after,
.game-art-studio.is-light .ga-rail button:not(.active) i::after {
  content: '';
  position: absolute;
  z-index: -1;
  inset: -6px;
  border: 1px solid rgba(88, 126, 151, 0.1);
  border-radius: 50%;
  background: radial-gradient(circle, rgba(50, 91, 119, 0.08), transparent 68%);
  box-shadow: inset 0 0 9px rgba(54, 101, 132, 0.08);
}

.game-art-studio .ga-rail button span,
.game-art-studio.is-light .ga-rail button span {
  color: #91a4b3;
  font-size: 11px;
}

.game-art-studio .ga-rail button:not(.ga-library)::after,
.game-art-studio.is-light .ga-rail button:not(.ga-library)::after {
  content: '';
  position: absolute;
  right: auto;
  bottom: -3px;
  ...
  width: 6px;
  height: 6px;
  border: 1px solid #48687e;
  background: #10202c;
  box-shadow: inset 0 0 0 1px rgba(83, 125, 151, 0.28);
  opacity: 0.86;
  pointer-events: none;
  transform: translateX(-50%) rotate(45deg);
}

.game-art-studio .ga-rail button:hover,
.game-art-studio .ga-rail button:focus-visible,
.game-art-studio.is-light .ga-rail button:hover,
.game-art-studio.is-light .ga-rail button:focus-visible {
  color: #dce9f1;
}

.game-art-studio .ga-rail button:hover::before,
.game-art-studio .ga-rail button:focus-visible::before,
.game-art-studio.is-light .ga-rail button:hover::before,
.game-art-studio.is-light .ga-rail button:focus-visible::before {
  border-color: rgba(70, 130, 169, 0.3);
  background: rgba(27, 54, 72, 0.54);
  opacity: 1;
}

.game-art-studio .ga-rail button.active,
.game-art-studio.is-light .ga-rail button.active {
  color: #ffffff;
}

.game-art-studio .ga-rail button.active::before,
.game-art-studio.is-light .ga-rail button.active::before {
  inset: 3px 2px 5px;
  border-color: rgba(205, 167, 96, 0.82);
  border-radius: 0;
  background:
    radial-gradient(circle at 50% 12%, rgba(66, 177, 255, 0.5), transparent 44%),
    #0d3154;
  clip-path: polygon(10px 0, calc(100% - 10px) 0, 100% 10px, 100% calc(100% - 10px), calc(100% - 10px) 100%, 10px 100%, 0 calc(100% - 10px), 0 10px);
  box-shadow:
    0 0 0 1px rgba(35, 137, 232, 0.66),
    inset 0 0 26px rgba(29, 136, 238, 0.4),
    0 0 20px rgba(30, 147, 255, 0.32);
}

.game-art-studio .ga-rail button.active i,
.game-art-studio.is-light .ga-rail button.active i {
  color: #8ee5ff;
  filter:
    drop-shadow(0 0 4px rgba(71, 188, 255, 0.88))
    drop-shadow(0 0 9px rgba(36, 139, 255, 0.66));
  transform: translateY(-2px) scale(1.14);
}

.game-art-studio .ga-rail button.active i::after,
.game-art-studio.is-light .ga-rail button.active i::after {
  content: '';
  position: absolute;
  top: -10px;
  left: 50%;
  ...
  box-shadow:
    ...
    0 0 12px #33b7ff,
    0 0 20px #1688ff;
  filter: drop-shadow(0 0 5px rgba(68, 188, 255, 0.9));
  transform: translateX(-50%);
}

.game-art-studio .ga-rail button.active span,
.game-art-studio.is-light .ga-rail button.active span {
  width: 72px;
  color: #f5fbff;
  font-weight: 700;
  text-align: center;
  text-shadow: 0 0 8px rgba(45, 154, 255, 0.5);
}

.game-art-studio .ga-rail button.active span::before,
.game-art-studio .ga-rail button.active span::after,
.game-art-studio.is-light .ga-rail button.active span::before,
.game-art-studio.is-light .ga-rail button.active span::after {
  content: '';
  position: absolute;
  top: -38px;
  width: 6px;
  height: 6px;
  border: 1px solid rgba(225, 183, 103, 0.82);
  background: #153e61;
  box-shadow:
    inset 0 0 0 1px rgba(8, 29, 47, 0.8),
    0 0 7px rgba(77, 174, 244, 0.28);
...
.game-art-studio .ga-rail .ga-library,
.game-art-studio.is-light .ga-rail .ga-library {
  width: 92px;
  height: clamp(72px, 9.5vh, 98px);
  color: #e7c47f;
  background-image: none;
}

.game-art-studio .ga-rail .ga-library::before,
.game-art-studio.is-light .ga-rail .ga-library::before {
  inset: 2px 3px;
  border-color: rgba(182, 141, 68, 0.6);
  border-radius: 0;
  background:
    radial-gradient(circle at 50% 38%, rgba(233, 173, 67, 0.18), transparent 46%),
    #211f1c;
  clip-path: polygon(8px 0, calc(100% - 8px) 0, 100% 8px, 100% calc(100% - 8px), calc(100% - 8px) 100%, 8px 100%, 0 calc(100% - 8px), 0 8px);
  box-shadow:
    inset 0 0 14px rgba(216, 160, 62, 0.09),
    0 0 10px rgba(214, 151, 48, 0.08);
  opacity: 1;
  transform: scale(1);
}

.game-art-studio .ga-rail .ga-library i,
.game-art-studio.is-light .ga-rail .ga-library i {
  color: #e8c070;
  filter:
    drop-shadow(0 0 7px rgba(235, 176, 65, 0.52))
    drop-shadow(0 0 14px rgba(235, 176, 65, 0.2));
}

.game-art-studio .ga-rail .ga-library span,
.game-art-studio.is-light .ga-rail .ga-library span {
  color: #d9bd84;
}

.game-art-studio .ga-rail .ga-library::after,
.game-art-studio.is-light .ga-rail .ga-library::after {
  content: '';
  position: absolute;
  z-index: 2;
  bottom: -6px;
  ...
  width: 8px;
  height: 8px;
  border: 1px solid rgba(233, 187, 96, 0.82);
  background: #493619;
  box-shadow:
    inset 0 0 0 2px #1d1d1a,
    0 0 10px rgba(235, 176, 65, 0.48);
  transform: translateX(-50%) rotate(45deg);
}

/* Light appearance keeps the same armor geometry with a silver-blue material pass. */
.game-art-studio.is-light .ga-rail {
  border-color: rgba(151, 130, 91, 0.5);
  background:
    radial-gradient(circle at 50% 0%, rgba(73, 151, 198, 0.16), transparent 34%),
    linear-gradient(90deg, rgba(117, 132, 140, 0.12), transparent 18% 82%, rgba(117, 132, 140, 0.12)),
    #edf2f3;
  box-shadow:
    inset 0 0 0 1px rgba(255, 255, 255, 0.88),
    inset 4px 0 10px rgba(163, 125, 63, 0.05),
    inset -4px 0 10px rgba(163, 125, 63, 0.05),
    inset 0 0 24px rgba(104, 125, 136, 0.12),
    0 16px 42px rgba(32, 50, 59, 0.12);
  color-scheme: light;
}

.game-art-studio.is-light .ga-rail::before {
  border-color: rgba(91, 125, 145, 0.24);
  box-shadow:
    inset 1px 0 rgba(172, 133, 68, 0.18),
    inset -1px 0 rgba(172, 133, 68, 0.18);
}

.game-art-studio.is-light .ga-rail::after {
  border-color: rgba(157, 123, 65, 0.64);
  background: #dce8ec;
  box-shadow:
    inset 0 0 0 2px #edf2f3,
    0 0 0 1px rgba(81, 121, 145, 0.24),
    0 0 10px rgba(51, 141, 198, 0.18);
}
...
.game-art-studio.is-light .ga-rail button {
  ...
  background-image: linear-gradient(
    90deg,
    transparent 10%,
    rgba(87, 119, 137, 0.28) 28%,
    rgba(87, 119, 137, 0.28) 72%,
    transparent 90%
  );
}
...
.game-art-studio.is-light .ga-rail button:not(.active) i::after {
  border-color: rgba(73, 111, 133, 0.13);
  background: radial-gradient(circle, rgba(83, 130, 157, 0.08), transparent 68%);
  box-shadow: inset 0 0 9px rgba(72, 113, 138, 0.07);
}

.game-art-studio.is-light .ga-rail button:not(.ga-library)::after {
  border-color: #7b9cad;
  background: #edf2f3;
  box-shadow: inset 0 0 0 1px rgba(99, 135, 154, 0.2);
}
...
.game-art-studio.is-light .ga-rail button:hover::before,
.game-art-studio.is-light .ga-rail button:focus-visible::before {
  border-color: rgba(74, 126, 158, 0.25);
  background: rgba(211, 226, 233, 0.72);
}
...
.game-art-studio.is-light .ga-rail .ga-library::before {
  border-color: rgba(174, 132, 61, 0.58);
  background:
    radial-gradient(circle at 50% 38%, rgba(226, 169, 67, 0.18), transparent 48%),
    #f3eee2;
  box-shadow:
    inset 0 0 14px rgba(184, 129, 42, 0.08),
    0 5px 14px rgba(106, 77, 33, 0.1);
}

.game-art-studio.is-light .ga-rail .ga-library i {
  color: #b17d25;
  filter: drop-shadow(0 0 7px rgba(214, 153, 48, 0.24));
}
...
.game-art-studio.is-light .ga-rail .ga-library::after {
  border-color: rgba(181, 135, 57, 0.74);
  background: #d6ad65;
  box-shadow:
    inset 0 0 0 2px #f3eee2,
    0 0 8px rgba(193, 137, 43, 0.24);
}

/* Full-page blue-steel fantasy treatment. */
.game-art-studio:not(.is-light) {
  --acid: #62d9ff;
  --cyan: #d6b26b;
  --magenta: #d6b26b;
  --amber: #f0c878;
  --panel: #101d28;
  --studio-accent: #62d9ff;
  --studio-accent-soft: rgba(98, 217, 255, 0.18);
  --studio-accent-glow: rgba(41, 143, 226, 0.2);
  --studio-surface-raised: #142735;
  --studio-surface-deep: #08131c;
  color: #dce8ef;
}

.game-art-studio:not(.is-light) .ga-canvas-title strong {
  border-left-color: #cba35c;
  color: #f1f7fa;
}

.game-art-studio:not(.is-light) .ga-canvas-status i,
.game-art-studio:not(.is-light) .ga-canvas-status.working i {
  background: #65d9ff;
  box-shadow: 0 0 10px rgba(69, 185, 255, 0.72);
}

.game-art-studio:not(.is-light) .ga-background-trigger,
.game-art-studio:not(.is-light) .ga-model-pick,
.game-art-studio:not(.is-light) .ga-background-menu,
.game-art-studio:not(.is-light) .ga-model-menu {
  border-color: rgba(152, 123, 74, 0.44);
  background: rgba(14, 29, 40, 0.94);
  color: #b9cbd6;
  box-shadow: inset 0 0 0 1px rgba(99, 151, 181, 0.08);
}

.game-art-studio:not(.is-light) .ga-background-trigger:hover,
.game-art-studio:not(.is-light) .ga-background-trigger:focus-visible,
.game-art-studio:not(.is-light) .ga-background-pick.open .ga-background-trigger,
.game-art-studio:not(.is-light) .ga-model-pick:hover,
.game-art-studio:not(.is-light) .ga-model-pick:focus-within,
.game-art-studio:not(.is-light) .ga-model-pick.open {
  border-color: rgba(84, 196, 247, 0.74);
  background: #142b3b;
}

.game-art-studio:not(.is-light) .ga-crosshair {
  border-color: rgba(71, 164, 215, 0.42);
  box-shadow:
    inset 0 0 30px rgba(35, 139, 214, 0.08),
    0 0 22px rgba(28, 132, 213, 0.08);
}

.game-art-studio:not(.is-light) .ga-crosshair::before,
.game-art-studio:not(.is-light) .ga-crosshair::after {
  background: rgba(80, 163, 207, 0.42);
}

.game-art-studio:not(.is-light) .ga-crosshair i {
  color: #68dcff;
  filter: drop-shadow(0 0 9px rgba(45, 166, 245, 0.5));
}

.game-art-studio:not(.is-light) .ga-inspo button {
  border-color: rgba(100, 139, 163, 0.3);
  background: rgba(13, 30, 42, 0.86);
  color: #8fa5b3;
  box-shadow: inset 0 1px rgba(255, 255, 255, 0.035);
}

.game-art-studio:not(.is-light) .ga-inspo button strong {
  color: #d8e5ec;
}

.game-art-studio:not(.is-light) .ga-inspo button:hover {
  border-color: rgba(94, 205, 255, 0.7);
  background: #142b3b;
  box-shadow:
    0 10px 26px rgba(2, 10, 16, 0.42),
    inset 3px 0 #c9a25c;
}

.game-art-studio:not(.is-light) .ga-console {
  border-color: rgba(146, 118, 72, 0.56);
  background: rgba(12, 26, 36, 0.95);
  box-shadow:
    inset 0 0 0 1px rgba(100, 151, 180, 0.1),
    inset 0 0 28px rgba(4, 11, 17, 0.44),
    0 18px 50px rgba(2, 8, 13, 0.4);
}

.game-art-studio:not(.is-light) .ga-console-title {
  border-bottom-color: rgba(151, 121, 70, 0.44);
  background:
    radial-gradient(circle at 18% 0%, rgba(43, 132, 190, 0.2), transparent 46%),
    #102330;
}

.game-art-studio:not(.is-light) .ga-console-title span,
.game-art-studio:not(.is-light) .ga-sec b {
  color: #72dcff;
}

.game-art-studio:not(.is-light) .ga-console-title em,
.game-art-studio:not(.is-light) .ga-field,
.game-art-studio:not(.is-light) .ga-field-label,
.game-art-studio:not(.is-light) .ga-style-hint,
.game-art-studio:not(.is-light) .ga-toggle-copy small,
.game-art-studio:not(.is-light) .ga-feature-trigger small {
  color: #8197a5;
}

.game-art-studio:not(.is-light) .ga-console-body {
  background: rgba(7, 19, 28, 0.32);
  scrollbar-color: #38566a transparent;
}

.game-art-studio:not(.is-light) .ga-console .ga-control-group,
.game-art-studio:not(.is-light) .ga-console details {
  border-color: transparent;
  background: transparent;
}

.game-art-studio:not(.is-light) .ga-console .ga-control-group > summary.ga-sec,
.game-art-studio:not(.is-light) .ga-sec {
  border-bottom-color: rgba(74, 111, 134, 0.28);
}

.game-art-studio:not(.is-light) .ga-control-group > summary.ga-sec > span {
  color: #b8c9d2;
}

.game-art-studio:not(.is-light) .ga-control-group > summary.ga-sec > em {
  background: rgba(67, 101, 121, 0.22);
  color: #8ca4b2;
}

.game-art-studio:not(.is-light) .ga-control-group[open] > summary.ga-sec > em {
  background: rgba(69, 186, 239, 0.13);
  color: #72dcff;
}

.game-art-studio:not(.is-light) .ga-section-toggle.is-on,
.game-art-studio:not(.is-light) .ga-toggles button.is-on .ga-mini-switch,
.game-art-studio:not(.is-light) .is-on > .ga-feature-switch {
  border-color: rgba(89, 205, 255, 0.58);
  background: rgba(54, 170, 225, 0.16);
}

.game-art-studio:not(.is-light) .ga-section-toggle.is-on > span,
.game-art-studio:not(.is-light) .ga-toggles button.is-on .ga-mini-switch > span,
.game-art-studio:not(.is-light) .is-on > .ga-feature-switch > span {
  background: #63d9ff;
  box-shadow: 0 0 9px rgba(51, 175, 242, 0.54);
}

.game-art-studio:not(.is-light) .ga-chiprow button,
.game-art-studio:not(.is-light) .ga-toggles button,
.game-art-studio:not(.is-light) .ga-sidebar-presets button,
.game-art-studio:not(.is-light) .ga-output-options button,
.game-art-studio:not(.is-light) .ga-stylegrid button,
.game-art-studio:not(.is-light) .ga-feature-trigger,
.game-art-studio:not(.is-light) .ga-feature-option,
.game-art-studio:not(.is-light) .ga-feature-segment {
  border-color: rgba(82, 116, 137, 0.34);
  background: #0e202c;
  color: #8fa3b0;
}

.game-art-studio:not(.is-light) .ga-chiprow button:hover:not(.is-on),
.game-art-studio:not(.is-light) .ga-toggles button:hover:not(.is-on),
.game-art-studio:not(.is-light) .ga-sidebar-presets button:hover:not(:disabled),
.game-art-studio:not(.is-light) .ga-output-options button:hover,
.game-art-studio:not(.is-light) .ga-stylegrid button:hover,
.game-art-studio:not(.is-light) .ga-feature-trigger:hover:not(:disabled) {
  border-color: rgba(101, 169, 205, 0.62);
  color: #e1edf2;
}

.game-art-studio:not(.is-light) .ga-chiprow button.is-on,
.game-art-studio:not(.is-light) .ga-toggles button.is-on,
.game-art-studio:not(.is-light) .ga-output-options button.is-on,
.game-art-studio:not(.is-light) .ga-stylegrid button.is-on {
  border-color: rgba(89, 205, 255, 0.72);
  background: rgba(45, 145, 198, 0.16);
  color: #74ddff;
  box-shadow: inset 0 -1px rgba(199, 163, 96, 0.34);
}

.game-art-studio:not(.is-light) .ga-composer {
  border-color: rgba(149, 120, 73, 0.56);
  background:
    radial-gradient(circle at 20% 0%, rgba(45, 132, 187, 0.14), transparent 42%),
    rgba(12, 27, 38, 0.96);
  box-shadow:
    0 16px 38px rgba(2, 8, 13, 0.46),
    inset 0 0 0 1px rgba(99, 151, 181, 0.08);
}

.game-art-studio:not(.is-light) .ga-composer:focus-within {
  border-color: rgba(91, 208, 255, 0.76);
  box-shadow:
    0 16px 38px rgba(2, 8, 13, 0.5),
    0 0 0 3px rgba(52, 166, 226, 0.12),
    inset 3px 0 #c9a25c;
}

.game-art-studio:not(.is-light) .ga-composer-ref-pick,
.game-art-studio:not(.is-light) .ga-feature-popover,
.game-art-studio:not(.is-light) .ga-composer-run .ga-generate {
  border-color: rgba(82, 116, 137, 0.4);
  background: #0b1c27;
  color: #9bafbb;
}

.game-art-studio:not(.is-light) .ga-composer-run .ga-generate:hover:not(:disabled) {
  border-color: rgba(94, 211, 255, 0.72);
  background: #122b3b;
  box-shadow:
    0 12px 30px rgba(2, 8, 13, 0.42),
    0 0 0 3px rgba(52, 166, 226, 0.1);
}

.game-art-studio:not(.is-light) .ga-generate-icon {
  border-color: rgba(94, 211, 255, 0.38);
  background: rgba(58, 172, 224, 0.12);
  color: #6bddff;
}

.game-art-studio:not(.is-light) .ga-generate-price > strong {
  color: #f0c878;
  text-shadow: 0 0 14px rgba(231, 172, 67, 0.28);
}

.game-art-studio:not(.is-light) .ga-card {
  border-color: rgba(104, 139, 159, 0.34);
  background: #0d1e2a;
}

.game-art-studio:not(.is-light) .ga-card-slot.is-active .ga-card,
.game-art-studio:not(.is-light) .ga-card.is-motion-hover,
.game-art-studio:not(.is-light) .ga-card:focus-within {
  border-color: rgba(91, 208, 255, 0.72);
  box-shadow:
    0 0 0 1px rgba(67, 169, 221, 0.16),
    0 0 24px rgba(29, 132, 211, 0.12);
}
...
.game-art-studio.is-light {
  ...
  --amber: #9b6b16;
  --panel: #edf2f3;
  --studio-accent: #187eae;
  --studio-accent-soft: rgba(24, 126, 174, 0.12);
  --studio-accent-glow: rgba(35, 128, 177, 0.1);
  --studio-surface-raised: #f4f7f7;
  --studio-surface-deep: #dfe8eb;
  color: #293b44;
}

.game-art-studio.is-light .ga-canvas-title strong {
  border-left-color: #a98547;
  color: #263942;
}

.game-art-studio.is-light .ga-console {
  border-color: rgba(151, 130, 91, 0.5);
  background: rgba(237, 242, 243, 0.97);
  box-shadow:
    inset 0 0 0 1px rgba(255, 255, 255, 0.8),
    inset 0 0 24px rgba(86, 111, 126, 0.08),
    0 18px 48px rgba(42, 61, 70, 0.13);
}

.game-art-studio.is-light .ga-console-title {
  border-color: rgba(151, 124, 77, 0.46);
  background:
    radial-gradient(circle at 18% 0%, rgba(52, 139, 194, 0.2), transparent 46%),
    #142936;
  color: #eff7fa;
}
...
.game-art-studio.is-light .ga-console-body {
  background: rgba(234, 240, 242, 0.7);
  scrollbar-color: #9eb2bc transparent;
}

.game-art-studio.is-light .ga-console .ga-control-group > summary.ga-sec,
.game-art-studio.is-light .ga-console details[open] summary {
  border-color: rgba(104, 132, 147, 0.24);
}
...
.game-art-studio.is-light .ga-feature-option,
.game-art-studio.is-light .ga-feature-segment {
  border-color: rgba(103, 132, 147, 0.3);
...
.game-art-studio.is-light .ga-output-options button.is-on,
.game-art-studio.is-light .ga-stylegrid button.is-on {
  border-color: rgba(25, 126, 174, 0.64);
  background: rgba(30, 132, 181, 0.1);
  color: #126f9b;
  box-shadow: inset 0 -1px rgba(158, 121, 61, 0.28);
}

.game-art-studio.is-light .ga-section-toggle.is-on,
.game-art-studio.is-light .ga-toggles button.is-on .ga-mini-switch,
.game-art-studio.is-light .is-on > .ga-feature-switch {
  border-color: rgba(27, 130, 179, 0.5);
  background: rgba(31, 135, 183, 0.13);
}
...
.game-art-studio.is-light .is-on > .ga-feature-switch > span {
  background: #187eae;
  box-shadow: 0 0 0 3px rgba(24, 126, 174, 0.08);
}

.game-art-studio.is-light .ga-inspo button {
  border-color: rgba(104, 132, 147, 0.26);
  background: rgba(247, 249, 249, 0.8);
  color: #667b85;
}

.game-art-studio.is-light .ga-inspo button:hover {
  border-color: rgba(24, 126, 174, 0.46);
  background: #ffffff;
  box-shadow:
    0 10px 26px rgba(47, 66, 75, 0.12),
    inset 3px 0 #a98547;
}
...
.game-art-studio.is-light .ga-composer {
  border-color: rgba(151, 130, 91, 0.5);
  background:
    radial-gradient(circle at 20% 0%, rgba(52, 139, 194, 0.08), transparent 44%),
    rgba(240, 245, 246, 0.96);
  box-shadow:
    0 16px 38px rgba(42, 61, 70, 0.13),
    inset 0 0 0 1px rgba(255, 255, 255, 0.78);
}

.game-art-studio.is-light .ga-composer:focus-within {
  border-color: rgba(24, 126, 174, 0.64);
  box-shadow:
    0 16px 38px rgba(42, 61, 70, 0.15),
    0 0 0 3px rgba(24, 126, 174, 0.1),
    inset 3px 0 #a98547;
}
...
.game-art-studio.is-light .ga-composer-run .ga-generate:hover:not(:disabled) {
  border-color: rgba(24, 126, 174, 0.58);
  background: #f4fafb;
  box-shadow:
    0 12px 28px rgba(42, 61, 70, 0.12),
    0 0 0 3px rgba(24, 126, 174, 0.08);
}

.game-art-studio.is-light .ga-generate-icon {
  border-color: rgba(24, 126, 174, 0.28);
  background: rgba(24, 126, 174, 0.08);
  color: #187eae;
}

.game-art-studio.is-light .ga-generate-price > strong {
  color: #9b6b16;
  text-shadow: none;
}
