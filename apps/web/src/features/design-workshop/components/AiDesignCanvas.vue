...
@media (max-width: 760px) {
  ...
  .adc-actions button:not(.is-primary):not(.is-icon):not(.is-panel-action),
  .adc-ai-status {
    display: none;
  }
  .adc-actions button.is-panel-action {
    width: 31px;
    padding: 0;
    font-size: 0;
  }
  .adc-actions button.is-panel-action i {
    font-size: 0.72rem;
  }
  .adc-actions button.is-primary {
    width: 31px;
  ...
  .adc-actions button.is-primary i {
    margin: 0;
    font-size: 0.7rem;
  }
  .adc-actions button.is-primary {
  ...
  .adc.is-region-analyzer .adc-inspector.has-selection {
    position: fixed;
    z-index: 30;
    right: 8px;
    bottom: 8px;
  ...
  .adc.is-region-analyzer .adc-inspector.has-selection::before {
    position: absolute;
    top: 7px;
    left: 50%;
    width: 34px;
  ...
  .adc-region-head {
    ...
    top: -17px;
    margin: 0 -11px;
    padding: 17px 13px 9px !important;
    background: rgba(23, 24, 30, 0.98);
  }
  .adc-canvas {
    grid-column: 1;
